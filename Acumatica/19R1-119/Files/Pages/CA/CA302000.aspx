    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" Caption="Reconciliation Summary" DataMember="CAReconRecords" NoteIndicator="True" FilesIndicator="True" LinkIndicator="True" NotifyIndicator="True"
        ...
        <Template>
            ...
            <px:PXSelector ID="edReconNbr" runat="server" DataField="ReconNbr" AutoRefresh="True" ValueField="ReconNbr" DataSourceID="ds" >
                 <GridProperties>
                     <Columns>
                           <px:PXGridColumn DataField="CashAccountID" Width="100px" />
                           <px:PXGridColumn DataField="ReconNbr" Width="100px" />
                           <px:PXGridColumn DataField="ReconDate"  Width="120px" />
                           <px:PXGridColumn DataField="Status"  Width="100px" />
                           <px:PXGridColumn DataField="CashAccountID_Description" Width="200px" />
                     </Columns>
                 </GridProperties>
            </px:PXSelector>
