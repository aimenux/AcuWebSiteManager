...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" AutoCallBack="True" Visible="True" Width="100%" PrimaryView="Rule" TypeName="PX.Objects.CA.CABankTranRuleMaintPopup">
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataMember="Rule" DataSourceID="ds"
        ...
        <Template>
            ...
            <px:PXMaskEdit runat="server" DataField="RuleCD" ID="edRuleCD" InputMask="&gt;CCCCCCCCCCCCCCCCCCCCCCCCCCCCCC" />            
