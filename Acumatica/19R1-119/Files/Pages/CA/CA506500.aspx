        ...
        <Levels>
            <px:PXGridLevel DataMember="Adjustments">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="CuryID" DisplayFormat="&gt;LLLLL" Label="Currency" Width="80px" />
                    ...
                    <px:PXGridColumn AllowNull="False" DataField="OrigModule" Label="Module" AutoCallBack="True" RenderEditorText="True" Width="70px" />
