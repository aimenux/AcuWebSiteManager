...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" runat="server" Width="100%" TypeName="PX.SM.AUProjectScreenMaint" PrimaryView="Pages" Visible="true">
        ...
        <DataTrees>
            ...
            <px:PXTreeDataMember TreeView="CustomSiteTreeForModifingScreens" TreeKeys="NodeID" />
		</DataTrees>
	</px:PXDataSource>
</asp:Content>
            ...
            <px:PXFormView ID="ViewSelectScreen" runat="server" Width="100%" DataSourceID="ds" SkinID="Transparent" DataMember="ViewSelectScreen">
                <Template>
	                <px:PXLayoutRule runat="server" ControlSize="L"/>
                   	<px:PXTreeSelector ID="SiteMap" runat="server" DataField="SiteMap" PopulateOnDemand="True" 
				ShowRootNode="False" TreeDataSourceID="ds" TreeDataMember="CustomSiteTreeForModifingScreens" MinDropWidth="413" CommitChanges="true">
				<DataBindings>
					<px:PXTreeItemBinding DataMember="CustomSiteTreeForModifingScreens" TextField="Title" ValueField="NodeID" ImageUrlField="Icon" ToolTipField="TitleWithPath" />
				</DataBindings>
