								...
								<Levels>
									<px:PXGridLevel DataMember="Components" >
										...
										<Columns>
											...
											<px:PXGridColumn DataField="TermStartDate" Width="81px" AutoCallBack="True"/>
											<px:PXGridColumn DataField="TermEndDate" Width="81px" AutoCallBack="True"/>
											<px:PXGridColumn DataField="ProjectID" Width="100px" AutoCallBack="True"/>
											<px:PXGridColumn DataField="TaskID" Width="100px" AutoCallBack="True"/>
											...
											<px:PXGridColumn DataField="FinPeriodID" Width="81px" AutoCallBack="True"/>
						...
						<Levels>
							<px:PXGridLevel DataMember="ReallocationPool" >
								<Columns>
									...
									<px:PXGridColumn DataField="ARTran__LineNbr" TextAlign="Right" Width="63px" />
									<px:PXGridColumn DataField="ARTran__BranchID" Width="81px"/>
									<px:PXGridColumn DataField="ARTran__InventoryID" Width="108px"/>
									<px:PXGridColumn DataField="ARTran__Qty" TextAlign="Right"/>
									<px:PXGridColumn DataField="ARTran__UOM" Width="50px"/>
									<px:PXGridColumn DataField="ARTran__CuryExtPrice" TextAlign="Right"/>
									<px:PXGridColumn DataField="ARTran__CuryTranAmt" TextAlign="Right" Width="100px" />
									<px:PXGridColumn DataField="INComponent__ComponentID" Width="108px"/>
									<px:PXGridColumn DataField="INComponent__Qty" TextAlign="Right"/>
									<px:PXGridColumn DataField="INComponent__UOM" Width="50px"/>
									<px:PXGridColumn DataField="DRScheduleDetail__DefCode" Width="91px" />
									<px:PXGridColumn DataField="DRScheduleDetail__FairValuePrice" Width="91px" />
									<px:PXGridColumn DataField="DRScheduleDetail__EffectiveFairValuePrice" Width="91px" />
									<px:PXGridColumn DataField="DRScheduleDetail__FairValueCuryID" Width="91px" />
									<px:PXGridColumn DataField="DRScheduleDetail__Percentage" Width="91px" />
									<px:PXGridColumn DataField="DRScheduleDetail__TotalAmt" TextAlign="Right" Width="108px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
