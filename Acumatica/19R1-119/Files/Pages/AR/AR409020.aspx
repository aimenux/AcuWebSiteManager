<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="AR409020.aspx.cs" 
	Inherits="Page_AR409020" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="true" TypeName="ReconciliationTools.ARGLDiscrepancyByCustomerEnq" PrimaryView="Filter" 
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" 
		Caption="Selection" DefaultControlID="edCustomerID">
		<Template>
	...
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="153px" Style="z-index: 100" Width="100%" 
		...
		<Levels>
			<px:PXGridLevel DataMember="Rows">
				...
				<Columns>
					<px:PXGridColumn DataField="AcctCD" Width="100px" LinkCommand="ViewCustomer" />
					<px:PXGridColumn DataField="AcctName" Width="120px" />
					...
					<px:PXGridColumn DataField="Discrepancy" TextAlign="Right" Width="100px" LinkCommand="ViewDetails" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
