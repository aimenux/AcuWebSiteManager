    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100; left: 0px; top: 0px;" Width="100%" 
        ...
        <Levels>
            <px:PXGridLevel DataMember="ARFinChargeRecords">
                <Columns>
                    <px:PXGridColumn AllowCheckAll="True" AllowNull="False" DataField="Selected" TextAlign="Center" Type="CheckBox" Width="30px" TextCase="Upper" />
                    ...
                    <px:PXGridColumn DataField="DueDate" Width="60px" />
                    ...
                    <px:PXGridColumn DataField="LastPaymentDate" Width="60px" />
                    <px:PXGridColumn DataField="LastChargeDate" Width="60px" />
