<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="AR512000.aspx.cs" Inherits="Page_AR512000" Title="Untitled Page" %>
<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Filter" PageLoadBehavior="PopulateSavedValues" TypeName="PX.Objects.AR.ARExpiringCardsProcess" />
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds"
        ...
        <Template>
            ...
            <px:PXCheckBox CommitChanges="True" ID="chkActiveOnly" runat="server" DataField="ActiveOnly" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px"
        ...
        AllowSearch="True" AllowPaging="True" SkinID="PrimaryInquire" FastFilterFields="BAccountID, Customer__AcctName, Customer__CustomerClassID, PaymentMethodID" SyncPosition="true">
        <Levels>
            <px:PXGridLevel DataMember="Cards">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="BAccountID" DisplayFormat="&gt;AAAAAAAAAA" Width="100px" LinkCommand="ViewCustomer" />
