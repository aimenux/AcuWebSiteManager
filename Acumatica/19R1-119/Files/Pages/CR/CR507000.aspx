		...
		<Levels>
			<px:PXGridLevel DataMember="Items">
				<Columns>
					...
					<px:PXGridColumn AllowUpdate="False" DataField="CaseCD" Width="90px" LinkCommand="Items_ViewDetails" />
					<px:PXGridColumn AllowUpdate="False" DataField="Subject" Width="300px" />
					...
					<px:PXGridColumn DataField="Customer__ClassID" Width="140px" />
					...
					<px:PXGridColumn AllowUpdate="False" DataField="LocationID" DisplayFormat="&gt;AAAAAA"
						Width="90px" />
					<px:PXGridColumn AllowUpdate="False" DataField="TimeBillable" Width="90px" />
					...
					<px:PXGridColumn AllowUpdate="False" DataField="ResolutionDate" Width="90px" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
