		...
		<Levels>
			<px:PXGridLevel DataMember="Contacts">
				<Columns>
                    ...
                    <px:PXGridColumn DataField="DisplayName" Width="150px" LinkCommand="Contacts_Contact_ViewDetails" />
                    <px:PXGridColumn DataField="ContactType" Width="80px" />
                    <px:PXGridColumn DataField="BAccountID" Width="150px" LinkCommand="Contacts_BAccount_ViewDetails" />
                    <px:PXGridColumn DataField="AcctName" Width="150px" />					
                    <px:PXGridColumn DataField="Status" Width="80px" />
					<px:PXGridColumn DataField="DuplicateStatus" Width="80px" />                    
				</Columns>
			</px:PXGridLevel>
		</Levels>
