						...
						<Levels>
							<px:PXGridLevel DataMember="Criteria">
								<Columns>
									...
									<px:PXGridColumn DataField="DataField" Width="250px" AutoCallBack="True">
									</px:PXGridColumn>
									<px:PXGridColumn DataField="Matching" Width="100px" AutoCallBack="True">
									</px:PXGridColumn>
						...
						<Levels>
							<px:PXGridLevel DataKeyNames="MergeID,DataField" DataMember="Methods">
								<Columns>
									...
									<px:PXGridColumn DataField="Method" Width="100px">
									</px:PXGridColumn>
								</Columns>
								<Layout FormViewHeight="" />
							</px:PXGridLevel>
