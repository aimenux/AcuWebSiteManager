		...
		<Items>
			<px:PXTabItem Text="General Info">
				<Template>
					...
					<px:PXSelector runat="server" ID="edCPriceClassID2" DataField="CPriceClassID2" TabIndex="110" />
					<px:PXSelector runat="server" ID="edCPriceClassID3" DataField="CPriceClassID3" TabIndex="120" />
