...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
	<px:PXGrid ID="grdItems" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
		...
		SkinID="PrimaryInquire" AutoCallback = "true" AutoGenerateColumns="AppendDynamic" RestrictFields="True" SyncPosition="true">
		<Levels>
			<px:PXGridLevel DataMember="Items">
				<Columns>
					...
					<px:PXGridColumn DataField="AcctCD" Width="150px" LinkCommand="Items_BAccountCRM_ViewDetails"/>
