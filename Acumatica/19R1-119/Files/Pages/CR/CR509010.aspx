<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="CR509010.aspx.cs" Inherits="Page_CR509010" %>

<%@ MasterType VirtualPath="~/MasterPages/ListView.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.CR.MergeProcess"
		PrimaryView="Items">
		<CallbackCommands>
		...
		<Levels>
			<px:PXGridLevel DataMember="Items">
				<Columns>
					...
					<px:PXGridColumn DataField="MergeCD" Width="200px" LinkCommand="viewDetails">
					</px:PXGridColumn>
