        ...
        <Items>
            ...
            <px:PXTabItem Text="GL Accounts">
                <Template>
                    ...
                    <px:PXSegmentMask ID="edDiscAcctID" runat="server" DataField="DiscAcctID" AllowEdit="True" />
                    ...
                    <px:PXSegmentMask ID="edDiscSubID" runat="server" DataField="DiscSubID" AutoRefresh="true">
                        <Parameters>
                            <px:PXControlParam ControlID="tab" Name="INPostClass.discAcctID" PropertyName="DataControls[&quot;edDiscAcctID&quot;].Value"
                                Type="String" />
                        </Parameters>
                    </px:PXSegmentMask>
