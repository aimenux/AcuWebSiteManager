	...
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" 
	    ...
	    <Levels>
			<px:PXGridLevel DataMember="INItemList" >
				...
				<Columns>
					<px:PXGridColumn DataField="Selected" AllowCheckAll="True" DataType="Boolean" TextAlign="Center" Type="CheckBox" Width="30px" />
					<px:PXGridColumn AllowUpdate="False" DataField="InventoryID" Width="120px" />
                    <px:PXGridColumn AllowUpdate="False" DataField="SiteID" Width="120px"/>
					<px:PXGridColumn AllowUpdate="False" DataField="InvtAcctID" Width="120px" />
					<px:PXGridColumn AllowUpdate="False" DataField="InvtSubID" Width="120px" />
					<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="PendingStdCost"
						DataType="Decimal" Decimals="4" DefValueText="0.0" TextAlign="Right" Width="99px" />
					<px:PXGridColumn AllowUpdate="False" DataField="PendingStdCostDate" DataType="DateTime" Width="90px" />
					<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="StdCost" DataType="Decimal"
						Decimals="4" DefValueText="0.0" TextAlign="Right" Width="99px" />
