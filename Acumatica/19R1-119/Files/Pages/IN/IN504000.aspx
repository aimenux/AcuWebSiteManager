		...
		Try to change filter to see records here." />
								<Levels>
									<px:PXGridLevel DataMember="LocationsToLock">
										...
										<Columns>
											<px:PXGridColumn DataField="LocationCD" Width="140px" />
		...
		Try to change filter to see records here." />
								<Levels>
									<px:PXGridLevel DataMember="ExcludedLocations">
										...
										<Columns>
											<px:PXGridColumn DataField="LocationID" Width="140px" AutoCallBack="True">
											</px:PXGridColumn>
											<px:PXGridColumn DataField="Descr" Width="220px">
											</px:PXGridColumn>
										</Columns>
			...
			<px:PXTabItem Text="Inventory Selection">
				<Template>
					<px:PXPanel DataMember="CurrentGeneratorSettings" runat="server">
		...
		Try to change filter to see records here." />
								<Levels>
									<px:PXGridLevel DataMember="InventoryItemsToLock">
										...
										<Columns>
											<px:PXGridColumn DataField="InventoryCD" Width="140px" />
											<px:PXGridColumn DataField="Descr"  Width="220px" />
										</Columns>
										<Layout FormViewHeight="" />
									</px:PXGridLevel>
		...
		Try to change filter to see records here." />
								<Levels>
									<px:PXGridLevel DataMember="ExcludedInventoryItems">
										...
										<Columns>
											<px:PXGridColumn DataField="InventoryID" Width="140px" AutoCallBack="True">
											</px:PXGridColumn>
											<px:PXGridColumn DataField="Descr" Width="220px">
											</px:PXGridColumn>
										</Columns>
