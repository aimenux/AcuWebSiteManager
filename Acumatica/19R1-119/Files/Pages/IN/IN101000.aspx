		...
		<Items>
			<px:PXTabItem Text="General Settings">
				<Template>
					...
					<px:PXLayoutRule runat="server" StartGroup="True" StartColumn="True" GroupCaption="Inventory Operations Settings" />
					<px:PXFormView ID="formScanSetup" runat="server" DataSourceID="ds" Width="100%" DataMember="ScanSetup" DefaultControlID="edUseDefaultQtyInReceipt" RenderStyle="Simple">
						<Template>
							...
							<px:PXCheckBox ID="edUseDefaultReasonInReceipt" runat="server" DataField="UseDefaultReasonCodeInReceipt" CommitChanges="true" />
							<px:PXCheckBox ID="edUseDefaultReasonInIssue" runat="server" DataField="UseDefaultReasonCodeInIssue" CommitChanges="true" />
							<px:PXCheckBox ID="edUseDefaultReasonInTransfer" runat="server" DataField="UseDefaultReasonCodeInTransfer" CommitChanges="true" />
							<px:PXCheckBox ID="edRequestLocationForEachItemInReceipt" runat="server" DataField="RequestLocationForEachItemInReceipt" CommitChanges="true" />
							<px:PXCheckBox ID="edRequestLocationForEachItemInIssue" runat="server" DataField="RequestLocationForEachItemInIssue" CommitChanges="true" />
							<px:PXCheckBox ID="edRequestLocationForEachItemInTransfer" runat="server" DataField="RequestLocationForEachItemInTransfer" CommitChanges="true" />
