	...
	<px:PXGrid ID="grid" runat="server" Height="144px" 
		...
		<Levels>
			<px:PXGridLevel  DataMember="ResultPreview">
				...
				<Columns>
					<px:PXGridColumn DataField="InventoryID" DisplayFormat="&gt;CCCCC-CCCCCCCCCCCCCCC" Width="180px" />
					<px:PXGridColumn DataField="Descr" Width="300px" />
					<px:PXGridColumn DataField="OldMC" Width="120px" />
                    <px:PXGridColumn DataField="MCFixed" TextAlign="Center" Type="CheckBox" Width="60px" />
					<px:PXGridColumn DataField="NewMC" Width="120px" />	
				</Columns>
			</px:PXGridLevel>
		</Levels>
