    ...
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100" AllowPaging="True" AllowSearch="true"
        ...
        <Levels>
            <px:PXGridLevel DataMember="Items">
                <Columns>
                    <px:PXGridColumn DataField="IsActive" Width="63px" Type="CheckBox" />
                    <px:PXGridColumn DataField="WorkCodeID" Width="108px" />
                    <px:PXGridColumn DataField="Description" Width="308px" />
                    <px:PXGridColumn DataField="CostCodeFrom" Width="108px" />
                    <px:PXGridColumn DataField="CostCodeTo" Width="108px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
