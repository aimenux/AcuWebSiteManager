	...
	<px:PXGrid ID="grid" runat="server" Height="150px" Width="100%" AdjustPageSize="Auto" Caption="Restriction Groups" AllowSearch="True" SkinID="Details">
		<Levels>
			<px:PXGridLevel DataMember="Groups">
				...
				<Columns>
				    <px:PXGridColumn DataField="Included" TextAlign="Center" Type="CheckBox" Width="30px" RenderEditorText="True" AllowCheckAll="True"/>
				    ...
				    <px:PXGridColumn DataField="GroupType" Label="Visible To Entities" RenderEditorText="True" Width="100px"/>
				</Columns>
				<RowTemplate>
