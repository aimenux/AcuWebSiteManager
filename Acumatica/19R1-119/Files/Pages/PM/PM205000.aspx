    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="Details" Caption="Sequences" SyncPosition="True">
        <Levels>
            <px:PXGridLevel DataMember="RateDefinitions">
                ...
                <Columns>
                    <px:PXGridColumn DataField="Sequence" Label="Sequence" SortDirection="Ascending" TextAlign="Right" Width="90px" />
                    <px:PXGridColumn DataField="Description" Label="Description" Width="190px" />
                    <px:PXGridColumn  DataField="Project" Label="Project" TextAlign="Center" Type="CheckBox" Width="90px" />
                    <px:PXGridColumn  DataField="Task" Label="Task" TextAlign="Center" Type="CheckBox" Width="90px" />
                    <px:PXGridColumn  DataField="AccountGroup" Label="Account Group" TextAlign="Center" Type="CheckBox" Width="108px" />
                    <px:PXGridColumn  DataField="RateItem" Label="Inventory" TextAlign="Center" Type="CheckBox" Width="90px" />
                    <px:PXGridColumn  DataField="Employee" Label="Employee" TextAlign="Center" Type="CheckBox" Width="90px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
