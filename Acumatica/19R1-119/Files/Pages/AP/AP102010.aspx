	...
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" Width="100%" AllowPaging="True" AdjustPageSize="Auto" Caption="Restriction Groups" AllowSearch="True" SkinID="Details"
		...
		<Levels>
			<px:PXGridLevel DataMember="Groups">
				...
				<Columns>
					<px:PXGridColumn DataField="Included" TextAlign="Center" Type="CheckBox" Width="50px" RenderEditorText="True" AllowCheckAll="True" />
					...
					<px:PXGridColumn AllowUpdate="False" DataField="Active" TextAlign="Center" Type="CheckBox" Width="50px" />
					<px:PXGridColumn AllowUpdate="False" DataField="GroupType" Label="Visible To Entities" RenderEditorText="True" Width="150px" />
				</Columns>
				<RowTemplate>
