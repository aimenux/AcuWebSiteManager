                    ...
                    <px:PXGrid ID="grid" runat="server" Height="144px" Width="100%" Style="z-index: 100" AllowPaging="True" ActionsPosition="Top"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="CurrentDiscounts">
                                <Columns>
                                    <px:PXGridColumn DataField="DiscountID" DisplayFormat="&gt;aaaaaaaaaa" Width="81px" LinkCommand="ViewAPDiscountSequence" CommitChanges="true" />
                                    <px:PXGridColumn DataField="Description" Width="300px" />
                                    <px:PXGridColumn AllowNull="False" DataField="Type" Width="99px" RenderEditorText="True" AutoCallBack="true" />
