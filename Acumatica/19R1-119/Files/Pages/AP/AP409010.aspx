<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="AP409010.aspx.cs" 
	Inherits="Page_AP409010" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="true" TypeName="ReconciliationTools.APGLDiscrepancyByAccountEnq" PrimaryView="Filter" 
		...
		<Levels>
			<px:PXGridLevel DataMember="Rows">
				...
				<Columns>
					...
					<px:PXGridColumn DataField="NonXXTrans" TextAlign="Right" Width="100px" />
