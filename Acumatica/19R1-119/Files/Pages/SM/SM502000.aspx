...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
		...
		<px:PXFormView ID="frmViewNotification" runat="server" DataSourceID="ds" Width="100%"
			...
			<Template>
				<px:PXTextEdit ID="edDetailsNotification" runat="server" DataField="NotificationBody" Height="550px"
					LabelID="lblDetailsNotification" Style="z-index: 101; border-style: none;" TextMode="MultiLine"
	...
	<px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100"
		AllowPaging="True" AllowSearch="true" AdjustPageSize="Auto" DataSourceID="ds" SkinID="Primary" AutoAdjustColumns="true" SyncPosition="true">
		<Levels>
