...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="WebServices"
		TypeName="PX.Api.SYWebServiceMaint">
		<CallbackCommands>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="300">
		...
		<Template1>
            ...
            ExpandDepth="1" DataMember="SiteMapTree" AllowCollapse="False">
				<ToolBarItems>
				...
				<Levels>
					<px:PXGridLevel DataMember="Schemas">
						<RowTemplate>
							...
							<px:PXTreeSelector CommitChanges="True" Size="xxs" ID="edScreenID" runat="server" DataField="ScreenID"
								PopulateOnDemand="True" ShowRootNode="False" TreeDataSourceID="ds" TreeDataMember="SiteMapTree">
								<DataBindings>
