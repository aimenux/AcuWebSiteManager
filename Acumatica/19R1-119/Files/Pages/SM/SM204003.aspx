...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" Width="100%" runat="server" Visible="True" PrimaryView="Notifications"
		...
		<DataTrees>
            ...
            <px:PXTreeDataMember TreeView="ReportSiteMap" TreeKeys="NodeID" />
		</DataTrees>
	</px:PXDataSource>
</asp:Content>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="150px" Style="z-index: 100" Width="100%"
		...
		<Items>
			...
			<px:PXTabItem Text="Reports Attached" VisibleExp="DataControls[&quot;chkShowReportTabExpr&quot;].Value=1" BindingContext="PXFormView1">
				<AutoCallBack Target="grdNavParams" Command="Refresh" ActiveBehavior="true">
					<Behavior RepaintControlsIDs="frmNavWindowMode" />
				</AutoCallBack>
				<Template>
					<px:PXSplitContainer runat="server" PositionInPercent="true" SplitterPosition="30" Width="100%">
						<AutoSize Enabled="True"  MinHeight="350" />
						<Template1>
							<px:PXGrid ID="grdNavScreens" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Reports" SkinID="Details"
									...
									<px:PXGridLevel DataMember="NotificationReports" SortOrder="CreatedDateTime">
										<RowTemplate>
											<px:PXTreeSelector ID="edNavScreen" runat="server" DataField="ScreenID" PopulateOnDemand="False" AutoRefresh="true"
												ShowRootNode="False" TreeDataSourceID="ds" TreeDataMember="ReportSiteMap" MinDropWidth="413" CommitChanges="true">
												<DataBindings>
													<px:PXTreeItemBinding DataMember="ReportSiteMap" TextField="Title" ValueField="ScreenID" ImageUrlField="Icon" ToolTipField="TitleWithPath" />
												</DataBindings>
											</px:PXTreeSelector>
										</RowTemplate>
										<Columns>
