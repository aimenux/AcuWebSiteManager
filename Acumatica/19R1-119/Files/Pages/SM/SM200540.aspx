...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" LinkIndicator="True"
		...
		<Template>
            ...
            <px:PXTreeSelector ID="edScreen" runat="server" DataField="ScreenID" PopulateOnDemand="True" ShowRootNode="False" ExpandDepth="1"
                TreeDataSourceID="ds" TreeDataMember="SiteMapTree" MinDropWidth="413" CommitChanges="True" OnValueChanged="resetGridPaging">
                <DataBindings>
