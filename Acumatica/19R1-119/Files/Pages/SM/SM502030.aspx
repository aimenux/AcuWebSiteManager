...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.BusinessProcess.UI.BusinessProcessEventHistoryMaint" SuspendUnloading="False"
         PrimaryView="Filter">
         <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="executeSubscriber" CommitChanges="True" Visible="False" RepaintControls="All" DependOnGrid="grid2"></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="deleteAll" CommitChanges="True" Visible="True" RepaintControls="All" DependOnGrid="grid"></px:PXDSCallbackCommand>
        </CallbackCommands>
    </px:PXDataSource>
    <%--<px:PXToolBar runat="server">
        <Items>
            <px:PXToolBarButton CommandName="viewEventDetails" CommandSourceID="ds" PopupPanel="pnlViewDetails"   DependOnGrid="grid" StateColumn="Status">
            </px:PXToolBarButton>
            <px:PXToolBarButton CommandName="restartFromLastFailedSubscriber" CommandSourceId="ds"  DependOnGrid="grid">
                <AutoCallBack >
      ...
      <px:PXSplitContainer runat="server" ID="sp1" SkinID="Horizontal" SplitterPosition="400">
        ...
        <Template1>
            <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" AllowFilter="True"  ActionsPosition="Top"
                ...
                <ActionBar>
                    <%--<CustomItems>
                        <px:PXToolBarButton CommandName="deleteAll" CommandSourceId="ds"  DependOnGrid="grid">
                            <AutoCallBack >
                                <Behavior  RepaintControls="All"></Behavior>
                            </AutoCallBack>
                        </px:PXToolBarButton>
                        <px:PXToolBarButton CommandName="viewEventDetails" CommandSourceId="ds"  DependOnGrid="grid" StateColumn="Status">
                            <AutoCallBack >
                                <Behavior  RepaintControls="All"></Behavior>
                            </AutoCallBack>
                        </px:PXToolBarButton>
