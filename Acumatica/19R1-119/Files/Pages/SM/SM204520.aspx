	...
	<px:PXSplitContainer runat="server" ID="SplitContainer" Width="100%" Height="500px" SplitterPosition="350" 
		...
		<Template1>
						...
						case 0: case 1: case 2: case 3: case 6:
							...
							if (key != ds[keyName])
							{
								switch (tab.selectedIndex)
                                {
									...
									case 1: ds.executeCallback("actionRefreshProperties"); break;
									case 2: ds.executeCallback("actionShowAttributes"); break;
									case 3: ds.executeCallback("actionShowEvents"); break;
									case 6: ds.executeCallback("actionShowAspxSource"); break;
								}
								ds[keyName] = key;
							}
							break;
			...
			<px:PXTreeView ID="TreePageControls" runat="server" DataSourceID="ds" DataMember="AspxPageControls" 
				...
				<ToolBarItems>
                    ...
                    <px:PXToolBarButton ImageKey="AddNew" CommandName="addNewAction" CommandSourceID="ds" DisplayStyle="Image"/>
		...
		<Template2>
			...
			<px:PXTab runat="server" ID="tab" AllowAutoHide="False" Width="100%" CssClass="tabView transparent" RepaintOnDemand="false">
				...
				<Items>
                    <px:PXTabItem Text="Main Properties">
                        <Template>
                            <px:PXSplitContainer ID="splt1" runat="server" Height="100%" PositionInPercent="true" SplitterPosition="60" Orientation="Horizontal">
                                <Template1>
                                    <px:PXGrid ID="StatePropGrid" runat="server" RenderDefaultEditors="True" DataSourceID="ds" LocalMenu="False"
                                        CssClass="GridMain Props" FastFilterFields="Name" StatusField="HelpString"
                                        Height="100px" Width="100%" AllowFilter="false">
                                        <ActionBar Position="Top" PagerVisible="False" ActionsHidden="true">
                                            <BottomGroups>
                                        ...
                                        <Levels>
                                            <px:PXGridLevel DataMember="StateProperties" SortOrder="OrderId">
                                                <Columns>
                                                    ...
                                                    <px:PXGridColumn DataField="IsCustomized" CommitChanges="True" TextAlign="Center" Width="75px" Type="CheckBox"/>
                                                    <px:PXGridColumn DataField="DisplayName" Width="250px" AllowUpdate="False" />
                                ...
                                <Template2>
                                    <px:PXFormView runat="server" SkinID="transparent" ID="parametersTitleFrom" 
                                        DataSourceID="ds" DataMember="ViewParametersTitle" Width="100%">
                                        <Template>
                                            <px:PXTextEdit runat="server" ID="ParametersTitle" DataField="ParametersTitle" SelectOnFocus="False"
                                                SkinID="Label" SuppressLabel="true"
                                                Width="90%"
                                                style="padding: 10px">
                                                <font size="10pt" names="Arial,sans-serif;"/>
                                            </px:PXTextEdit>
                                        </Template>
                                    </px:PXFormView>
                                    <px:PXGrid ID="StateParamGrid" runat="server" RenderDefaultEditors="True" DataSourceID="ds" LocalMenu="False"
                                        CssClass="GridMain Props" FastFilterFields="Name" StatusField="HelpString"
                                        Height="100px" Width="100%" AllowFilter="false">
                                        <ActionBar Position="Top" PagerVisible="False" ActionsHidden="true">
                                            <BottomGroups>
                                            ...
                                            <Actions>
                                                <Refresh ToolBarVisible="Top" Order="1" />
                                                <AddNew ToolBarVisible="Top" Order="2" />
                                                <Delete ToolBarVisible="Top" Order="3"/>
                                                <AdjustColumns ToolBarVisible="Top" Order="4" />
                                            </Actions>
                                        </ActionBar>

                                        <Levels>
                                            <px:PXGridLevel DataMember="StateControlParameters">
                                        ...
                                        <Mode AllowAddNew="True" AllowSort="False" AllowColMoving="False" />
                                        <Layout RowSelectorsVisible="False" HighlightMode="Cell" />
                                        <AutoSize Enabled="True" />
                                    </px:PXGrid>
                                </Template2>
