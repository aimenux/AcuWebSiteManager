...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.SM.TranslationSetMaint" PrimaryView="TranslationSet">
		<CallbackCommands>
    ...
    <px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="320">
        ...
        <Template1>
            <px:PXTreeView ID="tree" runat="server" DataSourceID="ds" Height="180px" PopulateOnDemand="True" AutoRepaint="True"
				RootNodeText="Pages" ShowRootNode="False" AllowCollapse="False" ExpandDepth="1" SelectFirstNode="true" DataMember="SiteMap">
				<ToolBarItems>
