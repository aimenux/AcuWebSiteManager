...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" Width="100%" runat="server" PrimaryView="RightsUser" TypeName="PX.SM.UserRightsAccess"
		Visible="False">
		<DataTrees>
     ...
     <px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="300">
          ...
          <Template2>
				...
				<px:PXGrid ID="griddet" runat="server" Height="200px" Width="100%" Style="z-index: 100;
					...
					MatrixMode="true" SkinID="Details" SyncPosition="true">
					<CallbackCommands>
					...
					<Levels>
						<px:PXGridLevel DataMember="UserRoleEntities">
							...
							<Columns>
								...
								<px:PXGridColumn AllowNull="False" DataField="RoleRight" TextAlign="Left">
									<ValueItems>
										<Items>
