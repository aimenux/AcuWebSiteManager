	...
	<px:PXGrid ID="grid" runat="server" AllowSearch="true" Width="100%"
		...
		<Levels>
			<px:PXGridLevel DataMember="FinPeriods">
				<Columns>
					<px:PXGridColumn DataField="Selected" TextAlign="Center" Type="CheckBox" AllowCheckAll="True" AllowNull="False" AllowSort="False" AllowMove="False" Width="30px" CommitChanges="true"/>
