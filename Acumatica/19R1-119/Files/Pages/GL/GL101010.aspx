					...
					<px:PXGrid ID="gridFrom" runat="server" Height="300px" Width="100%" SkinID="DetailsInTab"
						...
						<Levels>
							<px:PXGridLevel DataMember="MapFrom">
								...
								<Columns>
									<px:PXGridColumn DataField="ToBranchID" Width="100px">
									</px:PXGridColumn>
									<px:PXGridColumn DataField="FromAccountCD" Width="150px">
									</px:PXGridColumn>
									<px:PXGridColumn DataField="ToAccountCD" Width="150px">
									</px:PXGridColumn>
									<px:PXGridColumn DataField="MapAccountID" Width="150px">
									</px:PXGridColumn>
									<px:PXGridColumn DataField="MapSubID" Width="120px">
									</px:PXGridColumn>
								</Columns>
					...
					<px:PXGrid ID="gridTo" runat="server" Height="300px" Width="100%" SkinID="DetailsInTab"
						...
						<Levels>
							<px:PXGridLevel DataMember="MapTo">
								...
								<Columns>
									<px:PXGridColumn DataField="FromBranchID" Width="100px">
									</px:PXGridColumn>
									<px:PXGridColumn DataField="FromAccountCD" Width="150px">
									</px:PXGridColumn>
									<px:PXGridColumn DataField="ToAccountCD" Width="150px">
