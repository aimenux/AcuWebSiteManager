						...
						<Levels>
							<px:PXGridLevel DataMember="Account">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="Type" Width="100px" Type="DropDownList">
									</px:PXGridColumn>
									<px:PXGridColumn DataField="AccountClassID" Width="100px">
									</px:PXGridColumn>
									<px:PXGridColumn DataField="Active" Type="CheckBox" TextAlign="Center" Width="40px">
									</px:PXGridColumn>
									<px:PXGridColumn DataField="Description" Width="200px">
									</px:PXGridColumn>
									<px:PXGridColumn DataField="CuryID" Width="50px">
									</px:PXGridColumn>
								</Columns>
								<Layout FormViewHeight="" />
							</px:PXGridLevel>
