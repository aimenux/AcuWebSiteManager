                    ...
                    <px:PXGrid ID="grdOrganizaionLinks" runat="server" Height="300px" Width="100%" AllowSearch="True" SkinID="DetailsInTab" DataSourceID="ds" SyncPosition="True" AdjustPageSize="Auto">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="OrganizationLedgerLinkWithOrganizationSelect">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="OrganizationID" Width="150px" AutoCallBack="True" LinkCommand="ViewOrganization"/>
                                    <px:PXGridColumn DataField="Organization__OrganizationName" Width="300px"/>
                                    <px:PXGridColumn DataField="Organization__Active" TextAlign="Center" Type="CheckBox" Width="60px" />
                                    <px:PXGridColumn DataField="Organization__OrganizationType" Width="300px"/>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                    </px:PXGrid>
                    ...
                    <px:PXGrid ID="grdBranches" runat="server" Height="300px" Width="100%" AllowSearch="True" SkinID="DetailsInTab" DataSourceID="ds" AdjustPageSize="Auto">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="BranchesView">
                                <Columns>
                                    <px:PXGridColumn DataField="BranchCD" Width="150px"/>
