						...
						<Levels>
							<px:PXGridLevel DataMember="Account">
								...
								<Columns>
									<px:PXGridColumn DataField="Included" TextAlign="Center" Type="CheckBox" Width="30px"
										AllowCheckAll="True" />
									<px:PXGridColumn DataField="AccountCD" Width="81px" />
									<px:PXGridColumn  DataField="Type" Type="DropDownList" Width="72px" />
									<px:PXGridColumn DataField="AccountClassID" Width="81px" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Sub">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="SubCD" Width="108px" RenderEditorText="True" />
									<px:PXGridColumn  DataField="Active" TextAlign="Center" Type="CheckBox"
										Width="30px" RenderEditorText="True"  />
						...
						<Levels>
							<px:PXGridLevel DataMember="Segment">
								...
								<Columns>
									<px:PXGridColumn DataField="Included" TextAlign="Center" Type="CheckBox" Width="30px"
										AllowCheckAll="True" />
									<px:PXGridColumn DataField="Value" Width="176px" />
									<px:PXGridColumn DataField="Active" Width="40px" TextAlign="Center" Type="CheckBox" />
