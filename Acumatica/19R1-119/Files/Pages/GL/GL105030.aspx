						...
						<Levels>
							<px:PXGridLevel DataMember="BudgetTree">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="GroupID" Width="251px" TextField="Description" />
                                    <px:PXGridColumn DataField="AccountID" Width="108px" />
									<px:PXGridColumn DataField="SubID" Width="108px" />
									<px:PXGridColumn DataField="AccountMask" Width="108px" />
									<px:PXGridColumn DataField="SubMask" Width="108px" />
                                    <px:PXGridColumn DataField="IsGroup" Width="60px" Type="CheckBox" TextAlign="Center" />
								</Columns>
								<Layout FormViewHeight="" />
							</px:PXGridLevel>
						</Levels>
