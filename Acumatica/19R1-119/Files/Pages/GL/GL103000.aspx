	...
	<px:PXGrid ID="grid" runat="server" Height="378px" Style="z-index: 100; height: 378px;"
		...
		<Levels>
			<px:PXGridLevel DataMember="ConsolSetupRecords">
				<Columns>
					<px:PXGridColumn DataField="Selected" DefValueText="False" TextAlign="Center" Type="CheckBox"
						Width="30px" AllowCheckAll="True" AllowSort="False" AllowMove="False">
					</px:PXGridColumn>
					...
					<px:PXGridColumn DataField="SegmentValue" Width="80px">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="PasteFlag" TextAlign="Center" Type="CheckBox" Width="60px">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="Description" Width="150px">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="Login" Width="100px">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="Password" Width="100px">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="Url" Width="150px">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="SourceLedgerCD" AutoCallBack="true">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="SourceBranchCD">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="StartPeriod" Width="63px">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="EndPeriod" Width="63px">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="LastPostPeriod">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="LastConsDate">
					</px:PXGridColumn>
					<px:PXGridColumn DataField="BypassAccountSubValidation" DefValueText="False" TextAlign="Center"
						Type="CheckBox" Width="67px">
					</px:PXGridColumn>
				</Columns>
				<RowTemplate>
					<px:PXLayoutRule runat='server' StartColumn='True' LabelsWidth='M' ControlSize="M" />
