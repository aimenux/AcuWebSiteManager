	...
	<px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" 
		...
		<Levels>
			<px:PXGridLevel DataKeyNames="Module,TranType" DataMember="TranCodes">
				...
				<Columns>
					<px:PXGridColumn AutoGenerateOption="NotSet" DataField="Module" Label="Module" MaxLength="2"
						RenderEditorText="True" Width="90px" AutoCallBack="true">
					</px:PXGridColumn>
					<px:PXGridColumn AutoGenerateOption="NotSet" DataField="TranType" AutoCallBack="True"
						Label="Module Tran. Type" Width="90px" Type="DropDownList" MatrixMode="true">
					</px:PXGridColumn>
					<px:PXGridColumn AutoGenerateOption="NotSet" DataField="TranCode" Label="Unique Tran. Code"
						MaxLength="5" Width="90px">
					</px:PXGridColumn>
					<px:PXGridColumn AutoGenerateOption="NotSet" DataField="Descr" Label="Description"
						MaxLength="60" Width="255px">
					</px:PXGridColumn>
					<px:PXGridColumn  AutoGenerateOption="NotSet" DataField="Active"
						Label="Active" TextAlign="Center" Type="CheckBox" Width="60px">
					</px:PXGridColumn>
				</Columns>
