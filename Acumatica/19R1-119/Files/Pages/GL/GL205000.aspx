			...
			<px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100"
				...
				<Levels>
					<px:PXGridLevel DataMember="Details">
						...
						<Columns>
							<px:PXGridColumn DataField="IsGroup" TextAlign="Center" Type="CheckBox" Width="40px" AutoCallBack="true">
							</px:PXGridColumn>
							<px:PXGridColumn DataField="AccountID" AutoCallBack="true">
							</px:PXGridColumn>
							<px:PXGridColumn DataField="SubID" AutoCallBack="true" Width="110px">
							</px:PXGridColumn>
							<px:PXGridColumn DataField="Description" Width="200px">
							</px:PXGridColumn>
							<px:PXGridColumn DataField="AccountMask" Width="60px">
							</px:PXGridColumn>
							<px:PXGridColumn DataField="SubMask" Width="110px">
							</px:PXGridColumn>
