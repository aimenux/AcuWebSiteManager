		...
		<Levels>
			<px:PXGridLevel DataMember="Periods">
				<Columns>
					...
					<px:PXGridColumn DataField="Length" Width="70px" />
					<px:PXGridColumn DataField="Descr" Width="200px" />
					<px:PXGridColumn DataField="Status" />
					<px:PXGridColumn DataField="IsAdjustment" TextAlign="Center" Type="CheckBox" Width="90px" CommitChanges="true" />
					...
					<px:PXGridColumn DataField="Closed" TextAlign="Center" Type="CheckBox" Width="70px" />
