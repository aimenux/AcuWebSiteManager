<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="SO503500.aspx.cs" Inherits="Page_SO503500" Title="Untitled Page" %>
<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.SO.SOInvoiceOrder" PrimaryView="Filter" PageLoadBehavior="PopulateSavedValues">
		<CallbackCommands>
					...
					<px:PXSelector ID="edOrderType" runat="server" AllowNull="True" DataField="OrderType" 
						...
						<GridProperties>
							<Columns>
								...
								<px:PXGridColumn DataField="Descr"  Width="210px">
