                ...
                <Template>
					...
					<px:PXFormView ID="formScanSetup" runat="server" DataSourceID="ds" Width="100%" DataMember="PickPackShipSetup" DefaultControlID="edShowPickTab" RenderStyle="Simple">
						<Template>
							...
							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Fulfillment Settings" SuppressLabel="True" LabelsWidth="M" />
							<px:PXDropDown ID="edShortShipmentConfirmation" runat="server" DataField="ShortShipmentConfirmation" SuppressLabel="False" CommitChanges="True" />
							...
							<px:PXCheckBox ID="edConfirmEachPackageWeight" runat="server" DataField="ConfirmEachPackageWeight" CommitChanges="true" />
							<px:PXCheckBox ID="edRequestLocationForEachItem" runat="server" DataField="RequestLocationForEachItem" CommitChanges="true" />
						</Template>
					</px:PXFormView>
                </Template>
            </px:PXTabItem>
