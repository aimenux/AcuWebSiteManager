    ...
    <px:PXGrid ID="gridEmployees" runat="server" Height="400px" Width="100%" Style="z-index: 100"
		...
		<Levels>
			<px:PXGridLevel DataMember="SrvManagementStaffRecords">
                ...
                <Columns>
                    <px:PXGridColumn DataField="AcctCD" Width="120px" LinkCommand="Employee_ViewDetails">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="AcctName" Width="200px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="Type">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="BAccountStaffMember__ParentBAccountID" Width="120px">
                    </px:PXGridColumn>
