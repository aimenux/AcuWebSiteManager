<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="FS200100.aspx.cs" Inherits="Page_FS200100" Title="Untitled Page" %>
<%@ MasterType VirtualPath="~/MasterPages/ListView.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" Width="100%" runat="server" 
        TypeName="PX.Objects.FS.CauseMaint" 
        BorderStyle="NotSet" PrimaryView="CauseRecords" 
        SuspendUnloading="False" Visible="True">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100"
		...
		<Levels>
			<px:PXGridLevel DataMember="CauseRecords">
			    <RowTemplate>
                    <px:PXMaskEdit ID="CauseCD" runat="server" DataField="CauseCD" Size="S" CommitChanges="True">
                    </px:PXMaskEdit>
                    <px:PXTextEdit ID="Descr" runat="server" DataField="Descr" Size="M">
                    </px:PXTextEdit>
                </RowTemplate>
                <Columns>
                    <px:PXGridColumn DataField="CauseCD" Width="150px" CommitChanges="True">
                    </px:PXGridColumn>
