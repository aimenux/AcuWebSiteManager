                        ...
                        <Template>
                            ...
                            <px:PXGroupBox 
                                ...
                                <Template>
                                    ...
                                    <px:PXRadioButton ID="gbPostTo_op2" runat="server" GroupName="gbPostTo" Text="SO Invoice" Value="SI" />
                                    <px:PXRadioButton ID="gbPostTo_op3" runat="server" GroupName="gbPostTo" Text="None" Value="NA" />
                                </Template>
