            ...
            TabIndex="2300" SyncPosition="True" KeepPosition="True">
                <Levels>
                    <px:PXGridLevel DataMember="BatchDetailsInfo">
                        ...
                        <Columns>
                            <px:PXGridColumn DataField="PostedTO" Width="50px">
                            </px:PXGridColumn>
                            ...
                            <px:PXGridColumn DataField="FSServiceOrder__SrvOrdType" Width="100px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="AppointmentID" Width="100px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="FSServiceOrder__BillCustomerID" Width="100px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="Customer__AcctName" Width="200px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="SOID" Width="100px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="FSAppointment__ActualDateTimeBegin_Date" Width="90px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="FSAppointment__ActualDateTimeBegin_Time" Width="90px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="FSAppointment__ActualDateTimeEnd_Time" Width="90px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="FSServiceOrder__BranchLocationID" Width="120px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="FSGeoZone__GeoZoneCD" Width="120px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="FSServiceOrder__DocDesc" Width="200px">
                            </px:PXGridColumn>
                        </Columns>
                    </px:PXGridLevel>
                </Levels>
