                ...
                <Levels>
                    <px:PXGridLevel DataMember="ServiceOrderRecords">
                        ...
                        <Columns>
							...
							<px:PXGridColumn DataField="BranchLocationID" Width="150px"/>
                            <px:PXGridColumn DataField="SrvOrdType" Width="80px"/>                            
							...
							<px:PXGridColumn DataField="LocationID" Width="150px"/>
							<px:PXGridColumn DataField="OrderDate" Width="80px"/>
							<px:PXGridColumn DataField="Status" Width="80px"/>
							<px:PXGridColumn DataField="WFStageID" Width="80px"/>
							<px:PXGridColumn DataField="ServiceContractID" Width="150px"/>
							<px:PXGridColumn DataField="ScheduleID" Width="150px"/>
                        </Columns>
                    </px:PXGridLevel>
                </Levels>
