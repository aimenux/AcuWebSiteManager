            ...
            <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100"
		        ...
		        <Levels>
			        <px:PXGridLevel DataMember="Items">
                        ...
                        <Columns>
                            <px:PXGridColumn DataField="WFStageCD" Width="150px"></px:PXGridColumn>
                            <px:PXGridColumn DataField="AllowComplete" Width="110px" TextAlign="Center" Type="CheckBox"></px:PXGridColumn>
                            <px:PXGridColumn DataField="AllowCancel" Width="100px" TextAlign="Center" Type="CheckBox"></px:PXGridColumn>
                            <px:PXGridColumn DataField="AllowReopen" Width="100px" TextAlign="Center" Type="CheckBox"></px:PXGridColumn>
                            <px:PXGridColumn DataField="AllowClose" Width="90px" TextAlign="Center"   
                                Type="CheckBox"></px:PXGridColumn>
                            <px:PXGridColumn DataField="AllowModify" TextAlign="Center" Type="CheckBox" Width="100px">
                            </px:PXGridColumn>
                            <px:PXGridColumn DataField="AllowDelete" TextAlign="Center" Type="CheckBox" Width="90px">
                            </px:PXGridColumn>
