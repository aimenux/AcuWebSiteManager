        ...
        <Levels>
            <px:PXGridLevel DataKeyNames="RefNbr,LineNbr" DataMember="Transactions">
                <Columns>
                    ...
                    <px:PXGridColumn AllowNull="False" DataField="DebitAmt" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn AllowNull="False" DataField="CreditAmt" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="AccountID" Width="108" />
                    <px:PXGridColumn DataField="SubID" Width="198" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
