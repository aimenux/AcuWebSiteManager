		...
		<Levels>
			<px:PXGridLevel  DataMember="DisposalMethods">
				...
				<Columns>
					...
					<px:PXGridColumn DataField="DisposalMethodCD" DisplayFormat="&gt;CCCCCCCCCC" Label="Disposal Method" Width="108px" />
					<px:PXGridColumn DataField="Description" Label="Description" Width="200px" />
					<px:PXGridColumn DataField="ProceedsAcctID" DisplayFormat="&gt;######" Label="Proceeds Account" Width="80px" />
					<px:PXGridColumn DataField="ProceedsSubID" DisplayFormat="&gt;AA-AA-AA-AA-AAA" Label="Proceeds Subaccount" Width="120px" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
