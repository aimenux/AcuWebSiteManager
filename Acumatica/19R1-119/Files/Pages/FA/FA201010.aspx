    ...
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100"
		...
		<Levels>
			<px:PXGridLevel  DataMember="AssetTypes">
				...
				<Columns>
					<px:PXGridColumn DataField="AssetTypeID" Width="100px" />
					<px:PXGridColumn DataField="Description" Width="200px" />
					<px:PXGridColumn DataField="IsTangible" Width="70px" Type="CheckBox" TextAlign="Center" />
                    <px:PXGridColumn DataField="Depreciable" Width="70px" Type="CheckBox" TextAlign="Center" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
