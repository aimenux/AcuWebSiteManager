			...
			<px:PXGridLevel DataMember="Books">
				<Columns>
					<px:PXGridColumn AllowNull="False" DataField="Selected" TextAlign="Center" Type="CheckBox" Width="30px"
						AllowCheckAll="True" />
					<px:PXGridColumn AllowUpdate="False" DataField="OrganizationCD" Width="100px" />
					<px:PXGridColumn AllowUpdate="False" DataField="BookCode" DisplayFormat="&gt;CCCCCCCCCC" Width="110px"/>
