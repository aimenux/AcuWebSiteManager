				...
				<Levels>
					<px:PXGridLevel DataMember="GLTransactions">
						...
						<Columns>
							...
							<px:PXGridColumn AllowUpdate="False" DataField="SelectedQty" TextAlign="Right" Width="100px" />
							<px:PXGridColumn AllowUpdate="False" DataField="SelectedAmt" TextAlign="Right" Width="100px" />
							<px:PXGridColumn AllowUpdate="False" DataField="OpenQty" TextAlign="Right" Width="100px" />
							<px:PXGridColumn AllowUpdate="False" DataField="OpenAmt" TextAlign="Right" Width="100px" />
							<px:PXGridColumn AllowUpdate="False" DataField="GLTranQty" TextAlign="Right" Width="100px" />
							<px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="UnitCost" TextAlign="Right" Width="100px" />
							<px:PXGridColumn AllowUpdate="False" DataField="GLTranAmt" TextAlign="Right" Width="100px" />
							<px:PXGridColumn AllowUpdate="False" DataField="GLTranDate" Width="90px" />
							...
							<px:PXGridColumn DataField="GLTranDesc" Width="200px" />
						</Columns>
					</px:PXGridLevel>
				</Levels>
			...
			<px:PXGrid ID="gridSplit" runat="server" DataSourceID="ds" Style="z-index: 100; left: 0px; top: 0px; height: 280px;" Width="100%"
				...
				<Levels>
					<px:PXGridLevel DataMember="FATransactions">
						...
						<Columns>
							<px:PXGridColumn DataField="NewAsset" TextAlign="Center" Type="CheckBox" Width="65px" AutoCallBack="True" />
							<px:PXGridColumn DataField="Component" TextAlign="Center" Type="CheckBox" Width="60px" AutoCallBack="True" />
							<px:PXGridColumn DataField="ClassID" AutoCallBack="True" Width="80px" />
							<px:PXGridColumn AutoCallBack="True" DataField="AssetCD" Width="80px" />
							<px:PXGridColumn DataField="Qty" TextAlign="Right" Width="60px" />
							...
							<px:PXGridColumn DataField="Department" Width="90px" />
							<px:PXGridColumn DataField="TranType" RenderEditorText="True" Width="100px" />
							...
							<px:PXGridColumn DataField="FinPeriodID" DisplayFormat="##-####" Width="85px" CommitChanges="True"/>
							<px:PXGridColumn DataField="TranAmt" TextAlign="Right" Width="110px" AutoCallBack="True" />
