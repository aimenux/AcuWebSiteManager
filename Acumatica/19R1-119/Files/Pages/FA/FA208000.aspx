    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="Details" Caption="Details">
        <Levels>
            <px:PXGridLevel DataMember="Details">
                <Columns>
                    <px:PXGridColumn AutoCallBack="True" DataField="StartDate" Label="Start Date" Width="90px" />
                    <px:PXGridColumn AutoCallBack="True" DataField="EndDate" Label="End Date" Width="90px" />
                    <px:PXGridColumn DataField="BonusPercent" Label="Bonus, %" TextAlign="Right" Width="100px" />
                    <px:PXGridColumn DataField="BonusMax" Label="Max. Bonus" TextAlign="Right" Width="100px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
