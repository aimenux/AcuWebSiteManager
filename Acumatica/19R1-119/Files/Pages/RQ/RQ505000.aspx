		...
		<Levels>
			<px:PXGridLevel DataMember="Records" >
				...
				<Columns>
					...
					<px:PXGridColumn AllowUpdate="False" DataField="Priority" Width="54px" AllowNull="False" RenderEditorText="True" />
					<px:PXGridColumn DataField="ReqNbr" AllowUpdate="False"  />
					<px:PXGridColumn DataField="OrderDate" Width="90px" AllowUpdate="False" />					
					<px:PXGridColumn AllowUpdate="False" DataField="Status" Width="108px" AllowNull="False" RenderEditorText="True" />
					<px:PXGridColumn AllowUpdate="False" DataField="Description" Width="351px" />
					<px:PXGridColumn DataField="EmployeeID" AllowUpdate="False" Width="81px" DisplayFormat="&gt;AAAAAAAAAA" />
					...
					<px:PXGridColumn AllowUpdate="False" DataField="CuryID" Width="54px" DisplayFormat="&gt;LLLLL"  />
					<px:PXGridColumn AllowUpdate="False" DataField="CuryEstExtCostTotal" Width="100px" AllowNull="False" TextAlign="Right" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
