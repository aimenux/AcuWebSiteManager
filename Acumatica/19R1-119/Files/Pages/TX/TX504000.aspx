		...
		<Levels>
			<px:PXGridLevel DataKeyNames="TaxZoneID,ZipCode,TaxID" DataMember="Records">
				<Columns>
					...
					<px:PXGridColumn DataField="Descr" Label="Description" MaxLength="60" Width="200px" />
					<px:PXGridColumn AllowNull="False" DataField="TaxRate" Label="Tax Rate" TextAlign="Right" Width="100px" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
