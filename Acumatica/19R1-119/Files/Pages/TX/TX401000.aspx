						...
						<Levels>
							<px:PXGridLevel DataMember="TaxRecords">
								<Columns>
									...
									<px:PXGridColumn DataField="PreviousRate" TextAlign="Right" Width="100px" />
									<px:PXGridColumn DataField="IsTaxable" TextAlign="Center" Type="CheckBox" Width="60px" />
									<px:PXGridColumn DataField="IsFreight" TextAlign="Center" Type="CheckBox" Width="60px" />
									<px:PXGridColumn DataField="IsService" TextAlign="Center" Type="CheckBox" Width="60px" />
									<px:PXGridColumn DataField="IsLabor" TextAlign="Center" Type="CheckBox" Width="60px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="ZoneRecords">
                                        <Columns>
                                            ...
                                            <px:PXGridColumn DataField="Description" Width="200px" />
                                            <px:PXGridColumn DataField="CombinedRate" TextAlign="Right" Width="100px" />
                                        </Columns>
                                    </px:PXGridLevel>
                                </Levels>
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="ZoneDetailRecords">
                                        <Columns>
                                            <px:PXGridColumn DataField="ZoneID" />
                                            <px:PXGridColumn DataField="TaxID" />
                                            <px:PXGridColumn DataField="TaxRecord__Description" Width="200px" />
                                            <px:PXGridColumn DataField="TaxRecord__Rate" TextAlign="Right" Width="100px" />
                                            <px:PXGridColumn DataField="TaxRecord__EffectiveDate" Width="90px" />
                                            <px:PXGridColumn DataField="TaxRecord__PreviousRate" TextAlign="Right" Width="100px" />
                                            <px:PXGridColumn DataField="TaxRecord__IsTaxable" TextAlign="Center" Type="CheckBox" Width="60px" />
                                            <px:PXGridColumn DataField="TaxRecord__IsFreight" TextAlign="Center" Type="CheckBox" Width="60px" />
                                            <px:PXGridColumn DataField="TaxRecord__IsService" TextAlign="Center" Type="CheckBox" Width="60px" />
                                            <px:PXGridColumn DataField="TaxRecord__IsLabor" TextAlign="Center" Type="CheckBox" Width="60px" />
                                        </Columns>
                                    </px:PXGridLevel>
                                </Levels>
                                <AutoSize Enabled="True" MinHeight="150" />
