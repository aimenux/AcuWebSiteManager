					...
					<px:PXGrid ID="grid" runat="server" Width="100%" AllowSearch="true" DataSourceID="ds" SkinID="DetailsInTab">
						<Levels>
							<px:PXGridLevel DataMember="Items">
								...
								<Columns>
									<px:PXGridColumn DataField="StateCode" Width="90px" />
									<px:PXGridColumn DataField="StateName" Width="297px" />
									<px:PXGridColumn DataField="AccountID" Width="156px" />
									<px:PXGridColumn DataField="SubID" Width="156px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
