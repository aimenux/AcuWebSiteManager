		...
		<Items>
			...
			<px:PXTabItem Text="GL Accounts">
				<Template>
					...
					<px:PXSegmentMask ID="edRetainageTaxPayableAcctID" runat="server" DataField="RetainageTaxPayableAcctID" />
					<px:PXSegmentMask ID="edRetainageTaxPayableSubID" runat="server" DataField="RetainageTaxPayableSubID" />
					<px:PXSegmentMask ID="edRetainageTaxClaimableAcctID" runat="server" DataField="RetainageTaxClaimableAcctID" />
