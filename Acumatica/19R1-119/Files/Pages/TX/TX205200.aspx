	...
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Width="100%" ActionsPosition="top" Caption="Lines Update Rules" SkinID="Details">
		...
		<Levels>
			<px:PXGridLevel DataMember="BucketLine">
				...
				<Columns>
					<px:PXGridColumn DataField="LineNbr" DisplayMode="Hint" Width="350px" CommitChanges="True"/>
					<px:PXGridColumn DataField="TaxReportLine__LineType" Width="100px" RenderEditorText="True" />
					<px:PXGridColumn AllowNull="False" DataField="TaxReportLine__LineMult" Width="120px" RenderEditorText="True" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
