					...
					<px:PXGrid ID="gridShortcuts" runat="server" SkinID="Details" ActionsPosition="Top"
						...
						<Levels>
							<px:PXGridLevel DataMember="Shortcuts" DataKeyNames="Command">
								<Columns>
									<px:PXGridColumn TextAlign="Left" DataField="DisplayName" Width="200px" AllowUpdate="False" />
									<px:PXGridColumn TextAlign="Left" DataField="KeysDescription" Width="80px" AllowNull="False" />
								</Columns>
								<Layout FormViewHeight="" />
							</px:PXGridLevel>
						</Levels>
