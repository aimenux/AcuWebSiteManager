	...
	<px:PXGrid ID="grid" runat="server" Height="150px" Style="z-index: 100" Width="100%" Caption="Translation Definition Details" ActionsPosition="Top" AllowSearch="True" SkinID="Details">
		...
		<Levels>
			<px:PXGridLevel DataMember="TranslDefDetailsRecords">
				...
				<Columns>
					<px:PXGridColumn DataField="AccountIdFrom"  Width="80px" />
					<px:PXGridColumn DataField="AccountIdFrom_Account_description" Width="150px"  />
					<px:PXGridColumn DataField="SubIdFrom"  Width="100px" />
					<px:PXGridColumn DataField="AccountIdTo"  Width="80px" />
					<px:PXGridColumn DataField="AccountIdTo_Account_description" Width="150px" />
					<px:PXGridColumn DataField="SubIdTo" Width="100px" />
					<px:PXGridColumn DataField="CalcMode" Width="100px"  AutoCallBack="True" Type = "DropDownList" />
					<px:PXGridColumn DataField="RateTypeId"  />
					<px:PXGridColumn DataField="TranslDefId" Width="36px" Visible="False" AllowShowHide="False" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
