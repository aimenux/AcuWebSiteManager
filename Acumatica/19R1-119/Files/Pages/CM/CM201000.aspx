	...
	<px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100; left: 0px; top: 0px;" AllowPaging="True" ActionsPosition="Top" DataSourceID="ds" AdjustPageSize="Auto" AllowSearch="True"
		...
		<Levels>
			<px:PXGridLevel DataMember="CuryRateTypeRecords">
				...
				<Columns>
					<px:PXGridColumn DataField="CuryRateTypeID" Width="100px"  />
					<px:PXGridColumn DataField="Descr" Width="250px" />
					<px:PXGridColumn AllowNull="False" DataField="RateEffDays" TextAlign="Right" Width="80px" />
					<px:PXGridColumn DataField="RefreshOnline" Width="70px" Type="CheckBox" CommitChanges="True" TextAlign="Center"/>
					<px:PXGridColumn DataField="OnlineRateAdjustment" Width="110px" TextAlign="Right" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
