	 ...
	 <px:PXGrid ID="gridMaps" runat="server" DataSourceID="ds" ActionsPosition="Top"
        ...
        <Levels>
            <px:PXGridLevel DataMember="Maps">
                <Columns>
                    <px:PXGridColumn DataField="Name" Width="450px" LinkCommand="ViewDetails" />
					<px:PXGridColumn DataField="MapType" Width="250px" TextAlign="Left" />
                    <px:PXGridColumn DataField="EntityType" Width="250px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
