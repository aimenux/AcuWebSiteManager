    ...
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100" AllowPaging="True" ActionsPosition="Top"
        ...
        <Levels>
            <px:PXGridLevel DataMember="EPPosition">
                <Columns>
                    <px:PXGridColumn DataField="PositionID" DisplayFormat="&gt;aaaaaaaaaa" Width="90px" />
					<px:PXGridColumn DataField="SDEnabled" Width="150px" Type="CheckBox" TextAlign="Center" />
