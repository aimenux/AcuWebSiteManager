    ...
    <px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100" AllowPaging="True" ActionsPosition="Top"
        ...
        <Levels>
            <px:PXGridLevel DataMember="EPDepartment">
                ...
                <Columns>
                    <px:PXGridColumn DataField="DepartmentID" Width="100px" />
                    <px:PXGridColumn DataField="Description" Width="351px" />
                    <px:PXGridColumn DataField="ExpenseAccountID" AutoCallBack="true" Width="120px" />
                    <px:PXGridColumn DataField="ExpenseSubID" Width="120px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
