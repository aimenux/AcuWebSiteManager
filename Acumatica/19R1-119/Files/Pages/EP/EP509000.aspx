...
--%>
					...
					<px:PXGridColumn DataField="TimeSheetID" Width="108px" LinkCommand="viewDetails"  />
					<px:PXGridColumn DataField="Date" Width="90px" />
					<px:PXGridColumn AllowUpdate="False" Width="108px" DataField="EquipmentID" DisplayFormat="CCCCCCCCCC" />
