        ...
        <Levels>
            <px:PXGridLevel DataMember="Items">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="EmployeeID_description" Width="158px" />
                    <px:PXGridColumn DataField="WeekID" Label="Week" Width="158px" DisplayMode="Text" />
                    ...
                    <px:PXGridColumn DataField="WeekStartDate" Label="WeekStartDate" Width="81px" />
                 </Columns>
            </px:PXGridLevel>
        </Levels>
