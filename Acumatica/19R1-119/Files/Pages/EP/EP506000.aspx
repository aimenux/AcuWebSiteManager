		...
		<Levels>
			<px:PXGridLevel DataMember="ReminderList">
				<Columns>
					...
					<px:PXGridColumn DataField="Subject" Width="400px" AllowUpdate="False" AllowShowHide="False" LinkCommand="ViewActivity" />
					<px:PXGridColumn DataField="StartDate" DataType="DateTime" Width="130px" AllowUpdate="False" AllowShowHide="False" />
				</Columns>
				<RowTemplate>
