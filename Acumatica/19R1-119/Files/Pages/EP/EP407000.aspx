    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="PrimaryInquire" AdjustPageSize="Auto"
        ...
        <Levels>
            <px:PXGridLevel DataMember="Items">
                ...
                <Columns>
                    <px:PXGridColumn DataField="EquipmentID" Label="Equipment ID" Width="108px" />
                    <%--<px:PXGridColumn DataField="EquipmentID_description" Label="Description" Width="158px" />--%>
                    <px:PXGridColumn DataField="Status" Label="Status" Width="81px" Type="DropDownList" />
                    <px:PXGridColumn DataField="TimecardCD" Label="TimecardCD" Width="81px" />
                    
                    <px:PXGridColumn DataField="EPEquipmentTimeCardSpentTotals__SetupTime" Width="81px" RenderEditorText="True" />
                    <px:PXGridColumn DataField="EPEquipmentTimeCardSpentTotals__RunTime" Width="81px" RenderEditorText="True" />
                    <px:PXGridColumn DataField="EPEquipmentTimeCardSpentTotals__SuspendTime" Width="81px" RenderEditorText="True" />
                    <px:PXGridColumn DataField="EPEquipmentTimeCardSpentTotals__TimeTotalCalc" Width="81px" RenderEditorText="True" />
                    <px:PXGridColumn DataField="EPEquipmentTimeCardBillableTotals__SetupTime" Width="81px" RenderEditorText="True" />
                    <px:PXGridColumn DataField="EPEquipmentTimeCardBillableTotals__RunTime" Width="81px" RenderEditorText="True" />
                    <px:PXGridColumn DataField="EPEquipmentTimeCardBillableTotals__SuspendTime" Width="81px" RenderEditorText="True" />
                    <px:PXGridColumn DataField="EPEquipmentTimeCardBillableTotals__TimeTotalCalc" Width="81px" RenderEditorText="True" />
                 </Columns>
            </px:PXGridLevel>
        </Levels>
