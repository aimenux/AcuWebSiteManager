        ...
        <Levels>
            <px:PXGridLevel DataMember="Customers">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="CustomerID" Width="160px" />
                    <px:PXGridColumn DataField="CustomerID_BAccountR_acctName" Width="220px" />
                    <px:PXGridColumn DataField="LocationID" Width="120px" />
                    <px:PXGridColumn DataField="LocationID_Location_descr" Width="220px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
