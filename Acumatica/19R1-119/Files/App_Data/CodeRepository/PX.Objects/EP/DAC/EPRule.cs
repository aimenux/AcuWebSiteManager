...
namespace PX.Objects.EP
{
	...
	public partial class EPRule : IBqlTable
	{
		...
		[PXUIField(DisplayName = "Reason to Complete Approve Action")]
		[PXDefault(EPReasonSettings.NotRequired)]
		...
		[PXDBString(1, IsFixed = true)]
		[EPReasonSettings.List()]
		[PXUIField(DisplayName = "Reason to Complete Reject Action")]
		[PXDefault(EPReasonSettings.NotRequired)]
	...
	public static class EPReasonSettings
	{
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
					new string[] { NotRequired, Optional, Required },
					new string[] { Messages.NotRequired, Messages.Optional, Messages.Required })
			{
			}
		}
		...
		public class optional : Constant<string>
		{
			public optional() : base(Optional)
			{
			}
		}
		public class required : Constant<string>
		{
