				...
				if (currentTimeZone != null)
				{
					...
					if (pref != null && !string.IsNullOrEmpty(pref.TimeZone))
					{
						if (currentTimeZone.Id != pref.TimeZone)
						{
							...
							PXUIFieldAttribute.SetWarning<EPTimeCard.employeeID>(sender, e.Row, string.Format(PXMessages.LocalizeNoPrefix(Messages.TimeInTimezoneOfEmployee), currentTimeZone.DisplayName, empTimeZone.DisplayName));
						}
					}
