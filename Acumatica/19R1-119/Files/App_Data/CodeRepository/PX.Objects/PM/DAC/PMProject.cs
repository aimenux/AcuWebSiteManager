...
namespace PX.Objects.PM
{
	...
	public partial class PMProject : Contract, IAssign, PX.SM.IIncludable
	{
		...
		/// </summary>
		[PXCurrency(typeof(curyInfoID), typeof(asset))]
		...
		/// This value is calculated on the fly only in the <see cref="ProjectEntry"/> graph and is not stored in the DB. 
		/// </summary>
		[PXCurrency(typeof(curyInfoID), typeof(liability))]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		...
		/// This value is calculated on the fly only in the <see cref="ProjectEntry"/> graph and is not stored in the DB. 
		/// </summary>
		[PXCurrency(typeof(curyInfoID), typeof(income))]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		...
		/// This value is calculated on the fly only in the <see cref="ProjectEntry"/> graph and is not stored in the DB. 
		/// </summary>
		[PXCurrency(typeof(curyInfoID), typeof(expense))]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		...
		[PXBaseCury()]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		[PXUIField(DisplayName = "Assets in Base Currency", Enabled = false)]
		...
		[PXBaseCury()]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		[PXUIField(DisplayName = "Liabilities in Base Currency", Enabled = false)]
		...
		[PXBaseCury()]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		[PXUIField(DisplayName = "Income in Base Currency", Enabled = false)]
		...
		[PXBaseCury()]
		[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
		[PXUIField(DisplayName = "Expenses in Base Currency", Enabled = false)]
