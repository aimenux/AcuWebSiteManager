...
namespace PX.Objects.PM
{
	...
	public class PMProformaLine : PX.Data.IBqlTable, ISortOrder, IQuantify
	{
		...
		#endregion
		public decimal PrepaidAmountInProjectCurrency(bool useBaseCurrency)
		{
			return !useBaseCurrency ? CuryPrepaidAmount.GetValueOrDefault() : PrepaidAmount.GetValueOrDefault();
		...
		#endregion
		public decimal LineTotalInProjectCurrency(bool useBaseCurrency)
		{
			return !useBaseCurrency ? CuryLineTotal.GetValueOrDefault() : LineTotal.GetValueOrDefault();
