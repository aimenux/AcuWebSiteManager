...
namespace PX.Objects.FA
{
	public class CalcDeprProcess : PXGraph<CalcDeprProcess>
	{
		...
		protected virtual IEnumerable balances()
		{
			...
			{
				view.WhereAnd<Where<Branch.organizationID, Equal<Current<BalanceFilter.organizationID>>>>();
			}
			if (filter.BranchID != null)
			{
				view.WhereAnd<Where<Branch.branchID, Equal<Current<BalanceFilter.branchID>>>>();
			}
