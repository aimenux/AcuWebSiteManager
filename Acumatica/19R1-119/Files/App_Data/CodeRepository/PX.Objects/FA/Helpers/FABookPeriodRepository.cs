...
namespace PX.Objects.FA
{
	...
	{
		private static Dictionary<int, FABook> FABooks =>	PXDatabase.GetSlot<FABookCollection>(nameof(FABookCollection), typeof(FABook)).Books;
		...
		public static FABook FindFABook(int? bookID)
		{
		...
		public static bool IsPostingFABook(int? bookID)
		{
		...
		public virtual FABookPeriod GetMappedFABookPeriod(int? bookID, int? sourceOrganizationID, string sourcefinPeriodID, int? targetOrganizationID)
		{
			...
			return IsPostingFABook(bookID) && sourceOrganizationID != targetOrganizationID
				? GetFABookPeriodByMasterPeriodID(bookID, targetOrganizationID, sourceFABookPeriod?.MasterFinPeriodID)
		...
		public virtual ProcessingResult<FABookPeriod> GetFABookPeriodByMasterPeriodID(int? bookID, int? organizationID, string masterFinPeriodID)
		{
			...
			var result = ProcessingResult<FABookPeriod>.CreateSuccess(period);
