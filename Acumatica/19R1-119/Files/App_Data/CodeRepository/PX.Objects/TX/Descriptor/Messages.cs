...
namespace PX.Objects.TX
{
	...
	public static class Messages
	{
		...
		public const string GrossModeIsNotAvailableForDocument = "The Gross tax calculation mode cannot be used in a document that is subject to a tax code with the {0} option selected in the Calculate On box.";
		public const string NetModeIsNotAvailableForWithholdingType = "The Net tax calculation mode cannot be used in a document where a tax code with the {0} type is specified.";
		public const string GrossModeIsNotAvailableForUseType = "The Gross tax calculation mode cannot be used in a document where a tax code with the {0} type is specified.";
		#endregion
		...
		#region TaxCalcRule
		public const string CalcRuleExtract = "Extract From Item Amount";
		public const string CalcRuleItemAmt = "Calc. On Item Amount";
		public const string CalcRuleItemAmtPlusTaxAmt = "Calc. On Item + Tax Amount";
		public const string CalcRuleDocAmt = "Calc. On Document Amount";
		public const string CalcRuleDocAmtPlusTaxAmt = "Calc. On Document + Tax Amount";
		#endregion
		#endregion
