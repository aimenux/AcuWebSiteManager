...
namespace PX.Objects.SO
{
        ...
        where CustomerField: class,IBqlField
	{
		...
		public static void SetVerifyEnabled(SOOrderEntry graph, bool enabled)
		{
			var customerCreditHelper = graph.CustomerCreditHelper;
			if (customerCreditHelper != null)
				customerCreditHelper.VerifyEnabled = enabled;
		}
		...
		{
			if (VerifyEnabled && !IsLongOperationProcessing(sender.Graph))
