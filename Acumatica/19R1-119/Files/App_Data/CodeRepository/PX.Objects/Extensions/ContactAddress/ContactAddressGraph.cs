...
namespace PX.Objects.Extensions.ContactAddress
{
	public abstract class ContactAddressGraph<TGraph> : PXGraphExtension<TGraph> where TGraph : PXGraph
	{
		...
		protected virtual void DefaultRecords(Document row, ChangedData changedForContactInfo, ChangedData changedForShippingInfo)
		{
			...
			Debug.Print("needAskFromContactAddress={0}, {1} {2} {3}", needAskFromContactAddress, row.AllowOverrideContactAddress == true, !IsDefaultContactAdress(), !IsContactAddressNoChanged(changedForContactInfo));
			Debug.Print("needAskFromShippingContactAddress={0}, {1} {2} {3}", needAskFromShippingContactAddress, row.AllowOverrideShippingContactAddress == true, !IsDefaultShippingContactAdress(), !IsShippingContactAddressNoChanged(changedForContactInfo));
