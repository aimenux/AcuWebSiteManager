...
namespace PX.Objects.CS
{
	public class ReasonCodeMaint : PXGraph<ReasonCodeMaint, ReasonCode>
	{
        ...
        protected virtual void ReasonCode_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			PXUIFieldAttribute.SetVisible<ReasonCode.accountID>(sender, row, !row.Usage.IsIn(ReasonCodeUsages.Sales, ReasonCodeUsages.VendorReturn));
			PXUIFieldAttribute.SetVisible<ReasonCode.subID>(sender, row, !row.Usage.IsIn(ReasonCodeUsages.Sales, ReasonCodeUsages.VendorReturn));
			...
			if (row.Usage.IsIn(ReasonCodeUsages.Sales, ReasonCodeUsages.VendorReturn))
			{
        ...
        protected virtual void ReasonCode_RowPersisting(PXCache sender, PXRowPersistingEventArgs e)
		{
			...
			{
				bool allowEmptyAccount = ((ReasonCode)e.Row).Usage.IsIn(ReasonCodeUsages.Sales, ReasonCodeUsages.VendorReturn);
