...
namespace PX.Objects.CS
{
	public class AddressValidatorPluginMaint : PXGraph<AddressValidatorPluginMaint, AddressValidatorPlugin>
	{
		...
		{
			AddressValidatorPlugin m = PXSelectJoin<AddressValidatorPlugin, InnerJoin<Country, On<AddressValidatorPlugin.addressValidatorPluginID, Equal<Country.addressValidatorPluginID>>>, Where<Country.countryID, Equal<Required<Country.countryID>>>>.Select(graph, countryID);
