	...
	public class RMReportReaderGL : PXGraphExtension<RMReportReader>
    {
        ...
        public virtual void GLEnsureInitialized()
        {
            if (_historyLoaded == null)
            {
				...
				var res = PXSelectJoinOrderBy<CR.BAccount, InnerJoin<Branch, On<CR.BAccount.bAccountID, Equal<Branch.bAccountID>>>, OrderBy<Asc<CR.BAccount.acctCD>>>.Select(this.Base).ToList();
