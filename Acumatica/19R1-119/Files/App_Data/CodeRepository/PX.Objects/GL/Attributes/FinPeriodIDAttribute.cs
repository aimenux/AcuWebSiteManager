	...
	public class FinPeriodIDAttribute : OrganizationDependedPeriodIDAttribute
    {
        ...
        public override void FieldDefaulting(PXCache sender, PXFieldDefaultingEventArgs e)
        {
            ...
            if (HeaderMasterFinPeriodIDType != null && CalculatePeriodByHeader)
            {
                ...
                var finPeriodRepository = sender.Graph.GetService<IFinPeriodRepository>();
        ...
        {
            IFinPeriodRepository finPeriodRepository = cache.Graph.GetService<IFinPeriodRepository>();
        ...
        protected override void RedefaultPeriodID(PXCache cache, object row)
        {
            if (HeaderMasterFinPeriodIDType != null)
            {
                if (CalculatePeriodByHeader)
                {
                    ...
                    {
                        var finPeriodRepository = cache.Graph.GetService<IFinPeriodRepository>();
        ...
        {
            return cache.Graph.GetService<IFinPeriodRepository>()
