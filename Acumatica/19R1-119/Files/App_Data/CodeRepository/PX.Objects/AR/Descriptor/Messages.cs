...
namespace PX.Objects.AR
{
	...
	public static class Messages
	{
		...
		public const string PaymentProfileDiscontinuedProcCenter = "The {0} processing center set up for the selected customer payment method uses a discontinued plug-in. Set up the processing center to use a supported plug-in.";
