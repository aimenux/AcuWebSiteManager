...
namespace PX.Objects.FS
{
    public class TimeSlotMaint : PXGraph<TimeSlotMaint, FSTimeSlot>
    {
        ...
        /// </summary>
        private FSTimeSlot ConvertSlotToFSTimeSlot(Scheduler.Slot slot, FSTimeSlot fsTimeSlotRow, int slotLevel)
        {
        ...
        /// </summary>
        public static List<Scheduler.Slot> CompressListOfSlots(List<Scheduler.Slot> slotList, string availability)
        {
            if (slotList.Count == 0)
            {
                return slotList;
        ...
        /// </summary>
        public static List<Scheduler.Slot> CompressAndIntersectSlots(List<Scheduler.Slot> slotList)
        {
        ...
        /// </summary>
        private void CreateAndCompressedTimeSlots(FSTimeSlot fsTimeSlotRow, TimeSlotMaint timeSlotMaintGraph)
        {
        ...
        /// </summary>
        private void CreateCompressedSlots(List<Scheduler.Slot> compressedSlots, FSTimeSlot fsTimeSlotRow)
        {
        ...
        /// </summary>
        private void DeleteTimeSlotsByLevel(FSTimeSlot fsTimeSlotRow, int slotLevel)
        {
