    ...
    public class SMOpenPeriodAttribute : OpenPeriodAttribute
    {
        ...
        public SMOpenPeriodAttribute(Type sourceType, Type dependenceFieldType,
                ...
                : base(typeof(Search<FinPeriod.finPeriodID, 
                                    Where<Current<CreateInvoiceFilter.postTo>, NotEqual<CreateInvoiceFilter.postTo.SO>,
                                        And<FinPeriod.status, Equal<FinPeriod.status.open>,
                                        Or<Current<CreateInvoiceFilter.postTo>, Equal<CreateInvoiceFilter.postTo.SO>>>>>),
                            sourceType,
