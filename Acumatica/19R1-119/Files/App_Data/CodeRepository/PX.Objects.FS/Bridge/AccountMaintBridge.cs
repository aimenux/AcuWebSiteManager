...
namespace PX.Objects.FS
{
    public class AccountMaintBridge : PXGraph<AccountMaintBridge, BAccountSelectorBase>
    {
        ...
        protected virtual void BAccountSelectorBase_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            BAccountSelectorBase bAccountSelectorBaseRow = (BAccountSelectorBase)e.Row;
