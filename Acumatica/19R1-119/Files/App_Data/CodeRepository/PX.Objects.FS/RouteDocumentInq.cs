...
namespace PX.Objects.FS
{
    public class RouteDocumentInq : PXGraph<RouteDocumentInq>
    {
        ...
        #region EventFilter
        #region FilterPrivates

        private System.Type SetWhereStatus(bool? statusOpen, bool? statusInProcess, bool? statusCanceled, bool? statusCompleted, bool? statusClosed, PXSelectBase<FSRouteDocument> commandFilter)
        {
            // Open
