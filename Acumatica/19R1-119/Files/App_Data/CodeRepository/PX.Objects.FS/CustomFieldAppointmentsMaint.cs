...
namespace PX.Objects.FS
{
    public class CustomFieldAppointmentsMaint : PXGraph<CustomFieldAppointmentsMaint, FSCustomFieldAppointment>
    {
        ...
        public IEnumerable customFieldAppointmentRecords()
        {
        ...
        #endregion
        #region fsCustomFieldAppointmentEventHandlers
        protected virtual void FSCustomFieldAppointment_RowInserting(PXCache cache, PXRowInsertingEventArgs e)
        {
            if (e.Row == null) 
            { 
                return; 
