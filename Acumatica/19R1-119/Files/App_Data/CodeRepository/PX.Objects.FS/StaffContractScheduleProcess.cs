...
namespace PX.Objects.FS
{
    public class StaffContractScheduleProcess : PXGraph<StaffContractScheduleProcess>
    {
        ...
        /// </summary>
        protected void updateGeneratedSchedule(int scheduleID, DateTime? toDate, DateTime? lastGeneratedTimeSlotBySchedules, FSSchedule fsScheduleRow)
        {
        ...
        /// </summary>
        protected FSContractGenerationHistory getLastGenerationHistoryRowBySchedule(int scheduleID)
        {
            FSContractGenerationHistory fsContractGenerationHistoryRow = PXSelectGroupBy<FSContractGenerationHistory,
                                                                                        Where<
        ...
        protected virtual void StaffScheduleFilter_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
