...
namespace PX.Objects.FS
{
    public class SM_CRCaseMaint : PXGraphExtension<CRCaseMaint>
    {
        ...
        [PXRestrictor(typeof(
                Where<Current<CRCaseClass.requireCustomer>, Equal<False>,
        ...
        [PXDefault(typeof(Coalesce<Search2<BAccountR.defLocationID,
            ...
            Where<BAccountR.bAccountID, Equal<Current<CRCase.customerID>>,
                And<CRLocation.isActive, Equal<True>,
                And<MatchWithBranch<CRLocation.cBranchID>>>>>,
            Search<CRLocation.locationID,
            Where<CRLocation.bAccountID, Equal<Current<CRCase.customerID>>,
