...
{
    public class PXRedirectToGIWithParametersRequiredException : PX.Data.PXRedirectToUrlException
    {
        ...
        private static string BuildUrl(Guid designId, Dictionary<string, string> parameters)
        {
