...
namespace PX.Objects.FS.ParallelProcessing
{
        ...
        where StepGroupSharedType : StepGroup.StepGroupShared, new()
    {
        ...
        protected static bool IS_PARALLEL_PROCESSING_ACTIVE { get { return  WebConfig.ParallelProcessingDisabled == false && WebConfig.GetBool("EnableAutoNumberingInSeparateConnection", false); } }
