                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="RenewalHistory">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="RenewalDate" Width="130px" />
                                    <px:PXGridColumn DataField="RenewedBy"  Width="115px" />
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXTextEdit ID="edDate" runat="server" DataField="RenewalDate" />
                                    <px:PXSelector ID="edUser" runat="server" DataField="RenewedBy" />
