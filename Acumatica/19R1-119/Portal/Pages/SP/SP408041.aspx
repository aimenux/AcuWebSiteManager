<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormTab.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="SP408041.aspx.cs" Inherits="Page_SP408041"
	Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormTab.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Contact"
		TypeName="SP.Objects.CR.ProductContactMaint">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="CheckForDuplicates" Visible="False" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="ConvertToBAccount" Visible="False" CommitChanges="True" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" Width="100%" Caption="Contact Summary"
		...
		<Template>
		    ...
		    <px:PXSelector ID="edContactID" runat="server" DataField="ContactID" NullText="<NEW>" AllowNull="False"
		                  FilterByAllFields="True" AutoRefresh="True" SelectOnly="True" DisplayMode="Text"/>
			...
			<px:PXCheckBox ID="chkHasRigths" runat="server" DataField="HasRigths"/>  		
		</Template>
	</px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" DataSourceID="ds" Height="500px" DataMember="ContactCurrent"
		...
		<Items>
			...
			<px:PXTabItem LoadOnDemand="True" Text="User Info" BindingContext="form" VisibleExp="DataControls[&quot;chkHasRigths&quot;].Value = 1">
                <Template>
