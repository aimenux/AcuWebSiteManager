        ...
        <Levels>
            <px:PXGridLevel DataMember="Items">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="ContractCD" Label="Project ID" LinkCommand ="ViewProject"/>
                    <px:PXGridColumn DataField="Description" Label="Description" />
                    <px:PXGridColumn DataField="AllocationID" Label="Allocation Rule" DisplayMode="Hint" />
