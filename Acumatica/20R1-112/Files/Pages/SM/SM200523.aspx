<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="SM200523.aspx.cs" Inherits="Page_SM200523"
	Title="Untitled Page" %>

<%@ Register TagPrefix="px" Namespace="PX.Web.Controls" Assembly="PX.Web.Controls" %>
<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.SM.SPWikiCategoryMaint" PrimaryView="WikiCategory">
		<CallbackCommands>			
		</CallbackCommands>	
        <DataTrees>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		DataMember="WikiCategory" Caption="Wiki Category" TemplateContainer="" DefaultControlID="edCategoryID">
		<Template>
			<px:PXLayoutRule ID="PXLayoutRule1" runat="server" StartColumn="True" ControlSize="XM" LabelsWidth="SM" />
			<px:PXSelector ID="edCategoryID" runat="server" DataField="CategoryID" AutoRefresh="True" DataSourceID="ds"  />
...
<asp:Content ID="Content2" ContentPlaceHolderID="phG" runat="Server">
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Width="100%" ActionsPosition="Top" 
		...
		<Levels>
			<px:PXGridLevel DataMember="WikiCategoryDetails">
                <RowTemplate>
