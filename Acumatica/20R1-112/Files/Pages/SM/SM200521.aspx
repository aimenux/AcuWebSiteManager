<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="SM200521.aspx.cs" Inherits="Page_SM200521"
	Title="Portal Map Maintenance" %>

<%@ MasterType VirtualPath="~/MasterPages/ListView.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" Width="100%" runat="server" PrimaryView="SiteMap" TypeName="PX.SiteMap.Graph.PortalMapMaint"  Visible="True">
		<CallbackCommands>
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
