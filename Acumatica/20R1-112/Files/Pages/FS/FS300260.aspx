<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormTab.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="FS300260.aspx.cs" Inherits="Page_FS300260" Title="Untitled Page" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" PrimaryView="Filter" TypeName="PX.Objects.FS.AppCompleteTravelEntry" SuspendUnloading="False">
        <CallbackCommands>
            ...
            <px:PXTabItem Text="Selection">
                <Template>
                  <px:PXGrid ID="PXLogTravelLinesGrid" runat="server" DataSourceID="ds" Style="z-index: 100" SkinID="Inquire" TabIndex="800" SyncPosition="True" AllowPaging="True" AdjustPageSize="Auto" Width="100%" FilesIndicator="False" NoteIndicator ="False">
                    <Levels>
                        <px:PXGridLevel DataMember="LogActionTravelDetails" DataKeyNames="LineRef">
                            <RowTemplate>
