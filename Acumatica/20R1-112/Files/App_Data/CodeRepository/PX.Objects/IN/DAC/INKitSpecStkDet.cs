...
namespace PX.Objects.IN
{
	...
	public partial class INKitSpecStkDet : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class CompInventoryItem : InventoryItem.PK.ForeignKeyOf<INKitSpecStkDet>.By<compInventoryID> { }
			public class KitSpecHdr : INKitSpecHdr.PK.ForeignKeyOf<INKitSpecStkDet>.By<kitInventoryID, revisionID> { }
			public class CompSubItem : INSubItem.PK.ForeignKeyOf<INKitSpecStkDet>.By<compSubItemID> { }
		}
		#endregion
