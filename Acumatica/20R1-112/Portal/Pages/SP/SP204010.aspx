<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true"
	ValidateRequest="false" CodeFile="SP204010.aspx.cs" Inherits="Pages_SP204010"
	Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" AutoCallBack="True" Visible="true" Width="100%"
		PrimaryView="Filter" TypeName="SP.Objects.SP.SPCaseClosedInquiry" PageLoadBehavior="PopulateSavedValues">
		<CallbackCommands>
			<px:PXDSCallbackCommand DependOnGrid="gridClose" Name="viewCase" Visible="False" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="Filter" Caption="Selection"
		...
		<Template>
			...
			<px:PXSelector runat="server" ID="edContractID" DataField="ContractID" SuppressLabel="False"
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXGrid ID="gridClose" runat="server" DataSourceID="ds" ActionsPosition="Top"
		AllowPaging="true" AdjustPageSize="Auto" AllowSearch="true" SkinID="PrimaryInquire"
		Width="100%" FastFilterFields="CaseCD,Subject">
		<Levels>
			<px:PXGridLevel DataMember="FilteredItems">
				<Columns>
                    ...
                    <px:PXGridColumn DataField="LastActivity" DisplayFormat="g" Width="130px" />
