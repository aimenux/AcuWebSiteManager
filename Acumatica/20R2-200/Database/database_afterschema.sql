...
--[MinVersion(Hash = 2d32da0241b12bd50587c6f102c2d7cb28e2ebf00f41155989bd9e9844e8063a)]
UPDATE ARPayment SET PMInstanceID = null WHERE PMInstanceID = -1
GO

--[MinVersion(Hash = f9f23c6670cac19cadf27962c58a2b66db2e5f3ab7aba68a5cee5cae28c8ee35)]
UPDATE ExternalTransaction SET PMInstanceID = null WHERE PMInstanceID = -1
GO

--[MinVersion(Hash = 6439aa9b40a220331f2d4fdb50453582af2d10d69f0c17918f05573fd1b931ea)]
UPDATE CCProcTran SET PMInstanceID = null WHERE PMInstanceID = -1
GO

--start PJ package scripts
--[IfExists(Column = Contract.UsrCity)]
--[MinVersion(Hash = 9ec065b72815235ed0fb95020e74ea3c96fb7142cd120efb3dbccce923ce934c)]
...
SELECT
	...
	CreatedByScreenID,
	CreatedDateTime
FROM Contract WHERE BaseType = 'P' AND NonProject = 0
GO

--[IfNotExists(Column = Contract.UsrCity)]
--[MinVersion(Hash = dca6a72c05b9afacd6fd99c21a6c94e9083288b9abc929e6a969f3d8a09e71a1)]
INSERT INTO PMAddress(
	CompanyID,
	RevisionID,
	AddressLine1,
...
--[MinVersion(Hash = dde87d5694f1ba3d8543241118fa738bf3460d4ad032f630c7bff9b16092f112)]
UPDATE c
SET c.SiteAddressID = a.AddressID
FROM Contract c
INNER JOIN PMAddress a ON c.CompanyID = a.CompanyID and c.ContractID = a.ContractID AND a.CustomerID IS NULL
GO

--[mssql: Native]
--[mysql: Skip]
--[IfExists(Column = Contract.UsrCity)]
--[MinVersion(Hash = 2c1027c2c4be712f65978b9212e17a85d8e7c6d4f8a4a1439897a1376140d6f8)]
ALTER TABLE Contract DROP COLUMN UsrCity
GO
...
--[mssql: Native]
--[mysql: Skip]
--[IfExists(Column = Contract.UsrCountryId)]
--[MinVersion(Hash = cda9dbce71c92ac43cd7d024bcff8fd92fe986cf66b4da1d713590c86b025c8a)]
ALTER TABLE Contract DROP COLUMN UsrCountryId
GO
...
--[mssql: Native]
--[mysql: Skip]
--[IfExists(Column = Contract.UsrState)]
--[MinVersion(Hash = ee63a3ce6c25823220778733a8ec9c3a53b96e4d976d7c76053497f165e096b3)]
ALTER TABLE Contract DROP COLUMN UsrState
GO
...
--[mssql: Native]
--[mysql: Skip]
--[IfExists(Column = Contract.UsrPostalCode)]
--[MinVersion(Hash = a0d4e76d27acf43eec2b3b44d930d4ad88df8160ac546eb3ffbf71aaf0928519)]
ALTER TABLE Contract DROP COLUMN UsrPostalCode
GO
...
--[mssql: Native]
--[mysql: Skip]
--[IfExists(Column = Contract.UsrLatitude)]
--[MinVersion(Hash = c63569cd191237c4941538639d83a21eb51afa760d9c66687129d848de926201)]
ALTER TABLE Contract DROP COLUMN UsrLatitude
GO
...
--[mssql: Native]
--[mysql: Skip]
--[IfExists(Column = Contract.UsrLongitude)]
--[MinVersion(Hash = b112b4c1c09cbbfe5341ac8548329020138c2e933ae094e55ba9a75593959426)]
ALTER TABLE Contract DROP COLUMN UsrLongitude
GO
...
--end PJ package scripts
--[MinVersion(Hash = 4034287911b9752353d27a074b9aeab97d092a15d1ee01bc15006b3b68cecbce)]

GO

--[MinVersion(Hash = 180067f6e59564e0cd8a2fa87bd6d297aeafe2058e2366ce93b68103c18bb907)]
UPDATE ExternalTransaction SET DocType = RTRIM(DocType)
GO

--[MinVersion(Hash = 7531caef88b821819c4c474fb8070bf70442c661d7afa3d38e7d9a6b36c01ab5)]
UPDATE ExternalTransaction SET OrigDocType = RTRIM(OrigDocType)
GO

--[MinVersion(Hash = 9866f6605c2d24b1af583d8979ce2a6f6c24289a48342133e0293376a0e802dc)]
UPDATE CCProcTran SET DocType = RTRIM(DocType)
GO

--[MinVersion(Hash = ceac8f36934edcb02e452c4b62f6f985ed47b52987169551310ea24bbb500927)]
UPDATE CCProcTran SET OrigDocType = RTRIM(OrigDocType)
GO
