...
namespace PX.Objects.AM
{
    ...
    {
        internal string DebuggerDisplay => $"RecordID = {RecordID}, MachID = {MachID}, SchdDate = {SchdDate?.ToShortDateString()}, SchdTime(eff) = {SchdTime}({SchdEfficiencyTime})";
        ...
        [PXDefault(0)]
        [PXFormula(null, typeof(SumCalc<AMMachSchd.schdEfficiencyTime>))]
