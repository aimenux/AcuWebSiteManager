...
namespace PX.Objects.AM.GraphExtensions
{
    public class OpportunityMaintSalesTaxAMExtension : PXGraphExtension<OpportunityMaint.SalesTax, OpportunityMaint>
    {
            ...
            Action<object, decimal, decimal, decimal> del)
        {
            ...
            var curyEstimateTotal = oppExt.AMCuryEstimateTotal.GetValueOrDefault();
            if (curyEstimateTotal == 0 && oppExt.AMCuryEstimateTotal == null)
            {
                // Null when extension is not working. Manually get values...
                curyEstimateTotal = GetEstimateCuryExtPrice();
            }
