	...
	public class VendorLocationMaint : LocationMaint
	{
		...
		protected virtual void Location_IsAPPaymentInfoSameAsMain_FieldUpdated(PXCache sender, PXFieldUpdatedEventArgs e)
		{
			...
			if (record.IsAPPaymentInfoSameAsMain == false)
			{
				...
				record.OverrideRemitAddress = mainloc.OverrideRemitAddress;
				record.VRemitAddressID = mainloc.VRemitAddressID;
				record.OverrideRemitContact = mainloc.OverrideRemitContact;
				...
				copyloc.OverrideRemitAddress = record.OverrideRemitAddress;
				copyloc.VDefAddressID = record.VDefAddressID;
				copyloc.VRemitAddressID = record.VRemitAddressID;
				copyloc.OverrideRemitContact = record.OverrideRemitContact;
		...
		protected virtual void LocationAPPaymentInfo_RowUpdated(PXCache sender, PXRowUpdatedEventArgs e)
		{
            ...
            if (!sender.ObjectsEqual<LocationAPPaymentInfo.vCashAccountID, LocationAPPaymentInfo.vPaymentMethodID, LocationAPPaymentInfo.vPaymentLeadTime, LocationAPPaymentInfo.vPaymentByType, LocationAPPaymentInfo.vSeparateCheck, LocationAPPaymentInfo.isRemitAddressSameAsMain, LocationAPPaymentInfo.isRemitContactSameAsMain>(e.Row, e.OldRow))
			{
				...
				mainloc.OverrideRemitAddress = record.OverrideRemitAddress;
				mainloc.VRemitAddressID = record.VRemitAddressID;
				mainloc.OverrideRemitContact = record.OverrideRemitContact;
		...
		public class LocationRemitSharedContactOverrideGraphExt : SharedChildOverrideGraphExt<VendorLocationMaint, LocationRemitSharedContactOverrideGraphExt>
		{
			...
			protected override DocumentMapping GetDocumentMapping()
			{
				return new DocumentMapping(typeof(LocationAPPaymentInfo))
				{
					RelatedID = typeof(LocationAPPaymentInfo.bAccountID),
					ChildID = typeof(LocationAPPaymentInfo.vRemitContactID),
					IsOverrideRelated = typeof(LocationAPPaymentInfo.overrideRemitContact)
				};
			}
		...
		public class LocationRemitSharedAddressOverrideGraphExt : SharedChildOverrideGraphExt<VendorLocationMaint, LocationRemitSharedAddressOverrideGraphExt>
		{
			...
			protected override DocumentMapping GetDocumentMapping()
			{
				...
				{
					RelatedID = typeof(LocationAPPaymentInfo.bAccountID),
					ChildID = typeof(LocationAPPaymentInfo.vRemitAddressID),
					IsOverrideRelated = typeof(LocationAPPaymentInfo.overrideRemitAddress)
				};
			}
