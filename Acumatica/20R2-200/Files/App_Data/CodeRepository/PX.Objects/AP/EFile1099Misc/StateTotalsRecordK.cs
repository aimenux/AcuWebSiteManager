...
namespace PX.Objects.AP
{
    ...
    /// </summary>
    public class StateTotalsRecordK
    {
        ...
        [FixedLength(StartPosition = 304, FieldLength = 196)]
        ...
        [FixedLength(StartPosition = 508, FieldLength = 199)]
        public string Blank3 { get; set; }

        [FixedLength(StartPosition = 707, FieldLength = 18, PaddingStyle = PaddingEnum.Left, PaddingChar = '0')]
        public decimal StateIncomeTaxWithheldTotal { get; set; }

        [FixedLength(StartPosition = 725, FieldLength = 18, PaddingStyle = PaddingEnum.Left, PaddingChar = '0')]
        public decimal LocalIncomeTaxWithheldTotal { get; set; }

        [FixedLength(StartPosition = 743, FieldLength = 4)]
