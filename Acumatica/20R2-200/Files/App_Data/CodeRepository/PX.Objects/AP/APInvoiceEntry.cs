...
{ 
	...
	public class APInvoiceEntry : APDataEntryGraph<APInvoiceEntry, APInvoice>, PXImportAttribute.IPXPrepareItems, IGraphWithInitialization
	{
		...
		[PXBool]
		[DRTerms.Dates(typeof(APTran.dRTermStartDate), typeof(APTran.dRTermEndDate), typeof(APTran.inventoryID), typeof(APTran.deferredCode))]
			...
			bool errorIfUnreleasedAPExists = true)
		{
			...
			if (list != null)
			{
				...
				else
				{
					...
					if (usePOParameters && posetup.Current != null && posetup.Current.ChangeCuryRateOnReceipt == true)
					{
