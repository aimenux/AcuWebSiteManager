...
namespace PX.Objects.IN
{
	public class INReceiptEntry : INRegisterEntryBase, PXImportAttribute.IPXPrepareItems, IGraphWithInitialization
	{
		...
		public PXSelect<INTranSplit, Where<INTranSplit.docType, Equal<INDocType.receipt>, And<INTranSplit.refNbr, Equal<Current<INTran.refNbr>>, And<INTranSplit.lineNbr, Equal<Current<INTran.lineNbr>>>>>> splits; // using Current<> is valid, PXSyncGridParams used in aspx
