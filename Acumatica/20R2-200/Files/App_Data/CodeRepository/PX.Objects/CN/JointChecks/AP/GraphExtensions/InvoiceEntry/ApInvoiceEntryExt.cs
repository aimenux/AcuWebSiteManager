    ...
    public class ApInvoiceEntryExt : JointPayeeGraphExtBase<APInvoiceEntry>
    {
        ...
        protected virtual void _(Events.RowSelected<JointPayee> e)
        {
	        ...
	        e.Cache
		        ...
		        .For<JointPayee.jointPayeeInternalId>(attr => attr.Enabled = jointPayee.LinkedToPayment != true)
        ...
        private void UpdateJointPayeesTabAvailability(APInvoice invoice)
        {
	        ...
	        bool rowEditable = invoice.Status != APDocStatus.Closed && !IsRetainageBill;
