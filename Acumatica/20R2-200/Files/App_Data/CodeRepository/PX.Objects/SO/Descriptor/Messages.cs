...
namespace PX.Objects.SO
{
	...
	public static class Messages
	{
		...
		public const string SOOrderNotFound = "Sales Order was not inserted correctly.";
		...
		public const string CapturePaymentWithMultipleApplicationsError = "The {0} payment has multiple applications and cannot be captured for a separate document. To capture the payment, use the Actions > Capture CC Payment action on the Payments and Applications (AR302000) form.";
		public const string CapturePrepaymentWithMultipleApplicationsError = "The {0} prepayment has multiple applications and cannot be captured for a separate document. To capture the prepayment, use the Actions > Capture CC Payment action on the Payments and Applications (AR302000) form.";
		public const string VoidPaymentWithMultipleApplicationsError = "The {0} payment has multiple applications and cannot be voided for a separate document. To void the payment, use the Actions > Void CC Payment action on the Payments and Applications (AR302000) form.";
		public const string VoidPrepaymentWithMultipleApplicationsError = "The {0} prepayment has multiple applications and cannot be voided for a separate document. To void the prepayment, use the Actions > Void CC Payment action on the Payments and Applications (AR302000) form.";
		...
		public const string PaymentHasNoActiveAuthorizedOrCapturedTransactionsTriesMoreZero = "The maximum number of attempts to reauthorize the payment {0} has not been reached. To process payment {0} open the Payments and Applications (AR302000) form.";
		...
		public const string CaptureCCPayment = "Capture CC Payment";
		public const string VoidCCPayment = "Void CC Payment";
		public const string VoidExpiredCCPayment = "Void Expired CC Payment";
		public const string ValidateCCPayment = "Validate CC Payment";
		public const string ReAuthorizeCCPayment = "Re-Authorize CC Payment";
