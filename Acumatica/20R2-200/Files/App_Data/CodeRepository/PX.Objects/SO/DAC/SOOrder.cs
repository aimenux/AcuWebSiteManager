...
namespace PX.Objects.SO
{
    ...
    public partial class SOOrder : PX.Data.IBqlTable, PX.Data.EP.IAssign, IFreightBase, ICCAuthorizePayment, ICCCapturePayment, IInvoice, ICreatePaymentDocument
	{
		...
		[PXDefault(typeof(Coalesce<
			Search<CREmployee.defContactID, Where<CREmployee.userID, Equal<Current<AccessInfo.userID>>, And<CREmployee.status, NotEqual<BAccount.status.inactive>>>>, 
		...
		[PXFormula(typeof(
			IIf<Where<orderType, NotEqual<SOOrderTypeConstants.transferOrder>,
