...
namespace PX.Objects.PM
{
    ...
    public class ProjectEntry : PXGraph<ProjectEntry, PMProject>, PXImportAttribute.IPXPrepareItems, IGraphWithInitialization
	{
		...
		protected virtual void _(Events.CacheAttached<PMTask.defaultAccountID> e)
		{
		}
		...
		protected virtual void _(Events.CacheAttached<PMTask.defaultSubID> e)
		{
		}				
		...
		[PXDBString(2, IsKey = true, IsFixed = true, IsUnicode = true, InputMask = ">LL")]
		[PXDefault()]
		...
		public virtual void viewAddressOnMap()
		{
			...
			new MapService(this).viewAddressOnMap(address, Project.Current.SiteAddress);
		}
		#endregion
		...
		{
			if (CostCodeAttribute.UseCostCode() && Project.Current?.CostBudgetLevel == BudgetLevels.CostCode)
				e.Cache.SetDefaultExt<PMCostBudget.description>(e.Row);
		}
