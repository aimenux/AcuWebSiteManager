...
namespace PX.Objects.CS
{
	...
	public class FeaturesSet : IBqlTable
	{
		...
		[Feature(false, typeof(FeaturesSet.financialStandard), DisplayName = "Multiple Base Currencies", Visible = false)]
		...
		[FeatureDependency(typeof(FeaturesSet.branch))]
		[Feature(false, typeof(FeaturesSet.financialAdvanced), DisplayName = "Customer Visibility Restriction")]
        ...
        [Feature(typeof(FeaturesSet.integrationModule), DisplayName = "Expense Receipt Recognition Service")]
		...
		[Feature(typeof(integrationModule), DisplayName = "Document Recognition Service")]
