...
namespace PX.Objects.RQ
{
	...
	[PXEMailSource]
	[PXGroupMask(typeof(LeftJoinSingleTable<Customer, On<Customer.bAccountID, Equal<RQRequisition.customerID>, And<Match<Customer, Current<AccessInfo.userName>>>>,
					LeftJoinSingleTable<Vendor, On<Vendor.bAccountID, Equal<RQRequisition.vendorID>, And<Match<Vendor, Current<AccessInfo.userName>>>>>>),
		WhereRestriction = typeof(Where2<Where<Customer.bAccountID, IsNotNull, Or<RQRequisition.customerID, IsNull>>, 
									And<Where<Vendor.bAccountID, IsNotNull, Or<RQRequisition.vendorID, IsNull>>>>))]
