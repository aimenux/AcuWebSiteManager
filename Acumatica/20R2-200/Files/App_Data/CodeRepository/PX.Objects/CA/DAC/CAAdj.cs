...
namespace PX.Objects.CA
{
	...
	{
		//CompanyID, AdjRefNbr, AdjTranType

		#region Keys
		public class PK : PrimaryKeyOf<CAAdj>.By<adjRefNbr, adjTranType>
		{
			public static CAAdj Find(PXGraph graph, string adjRefNbr, string adjTranType) => FindBy(graph, adjRefNbr, adjTranType);
		}
		#endregion
