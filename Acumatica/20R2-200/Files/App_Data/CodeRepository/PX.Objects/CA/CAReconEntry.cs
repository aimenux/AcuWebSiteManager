...
namespace PX.Objects.CA
{
	public class CAReconEntry : PXGraph<CAReconEntry>
	{
		...
		#region Report Menu
		public PXMenuAction<CARecon> reportsMenu;
		...
		[PXUIField(
			...
			Visible = true)]
		[PXButton]
		public virtual IEnumerable PrintReconciliationReport(PXAdapter adapter)
		{
			string reportID = "CA627000";
		...
		public CAReconEntry()
		{
			...
			reportsMenu.AddMenuAction(printReconciliationReport);
