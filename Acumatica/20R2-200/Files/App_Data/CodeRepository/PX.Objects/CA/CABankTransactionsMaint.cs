...
namespace PX.Objects.CA
{
    public partial class CABankTransactionsMaint : PXGraph<CABankTransactionsMaint>
	{
		...
		protected virtual IEnumerable Cancel(PXAdapter adapter)
		{
			...
			Clear();
			TranFilter.Current.CashAccountID = cashAccount;
			return adapter.Get();
		}
		...
		[PXRestrictor(typeof(Where<BAccountR.status, In3<BAccountR.status.active, BAccountR.status.oneTime,
		...
		{
			bqlParams = new List<object>() { aDetail.TranType, aDetail.CuryID, aDetail.TranDate };
