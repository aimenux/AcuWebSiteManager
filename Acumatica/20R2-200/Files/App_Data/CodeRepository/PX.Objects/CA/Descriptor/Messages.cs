...
namespace PX.Objects.CA
{
	...
	public static class Messages
	{
		...
		public const string ExpenseCashAccountUsesInactiveGLAccount = "The document cannot be released because the {0} cash account of an expense uses the inactive {1} GL Account. To release the document with this cash account, activate the GL Account on the Chart of Accounts (GL202500) form.";
