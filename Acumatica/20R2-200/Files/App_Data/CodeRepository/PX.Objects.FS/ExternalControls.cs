    ...
    public class ExternalControls : PXGraph<ExternalControls>
    {
        ...
        public List<FSAppointmentStaffScheduleBoard> GetAppointmentRecords(DateTime timeBegin, DateTime timeEnd, int? branchID, int? branchLocationID, int[] employeeIDList)
        {
            ...
            BqlCommand appointmentRecords = new Select2<FSAppointmentStaffScheduleBoard,
                                                        ...
                                                        Where<
                                                            FSAppointmentStaffScheduleBoard.scheduledDateTimeEnd, GreaterEqual<Required<FSAppointmentStaffScheduleBoard.scheduledDateTimeEnd>>,
                                                        And<
                                                            FSAppointmentStaffScheduleBoard.scheduledDateTimeBegin, LessEqual<Required<FSAppointmentStaffScheduleBoard.scheduledDateTimeBegin>>,
                                                        And<
                                                            Where<Customer.bAccountID, IsNull,
                                                            Or<Match<Customer, Current<AccessInfo.userName>>>>>>>,
                                                        OrderBy<
            ...
            foreach (FSCustomAppointmentStatus fsCustomAppointmentStatusRow in bqlResultSet)
            {
                ...
                if (fsCustomAppointmentStatusRow.FieldName == TX.Status_Appointment.PAUSED && fsCustomAppointmentStatusRow.HideStatus == false)
                {
                    appointmentStatusesList.Add(ID.Status_Appointment.PAUSED);
                }
            }
        ...
        public List<FSAppointmentScheduleBoard> GetAppointmentRecordsByRooms(DateTime timeBegin, DateTime timeEnd, int? branchID, int? branchLocationID, int[] roomIDList)
        {
            ...
            BqlCommand appointmentRecords = new Select2<FSAppointmentScheduleBoard,
                                                    ...
                                                    And2<
                                                        Where<
                                                            FSAppointmentScheduleBoard.scheduledDateTimeEnd, GreaterEqual<Required<FSAppointmentScheduleBoard.scheduledDateTimeEnd>>,
                                                        And<
                                                            FSAppointmentScheduleBoard.scheduledDateTimeBegin, LessEqual<Required<FSAppointmentScheduleBoard.scheduledDateTimeBegin>>>>,
                                                    And<
                                                        Where<Customer.bAccountID, IsNull,
                                                        Or<Match<Customer, Current<AccessInfo.userName>>>>>>>,
                                                OrderBy<
        ...
        public List<FSAppointmentScheduleBoard> UnassignedAppointmentRecords(DateTime timeBegin, DateTime timeEnd, int? branchID, int? branchLocationID, bool? unassignedAppointmentByRoom, DispatchBoardFilters[] filters)
        {
            ...
            PXSelectBase<FSAppointmentScheduleBoard> appointmentRecords = 
                    new PXSelectJoin<FSAppointmentScheduleBoard,
                                LeftJoin<FSAddress,
