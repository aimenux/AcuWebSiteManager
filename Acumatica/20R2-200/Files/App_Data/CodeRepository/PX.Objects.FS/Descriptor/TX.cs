...
namespace PX.Objects.FS
{
    public static class TX
    {
        ...
        public static class Error
        {
            ...
            public const string LogActionNotAllowedWithCurrentAppointmentStatus                                = "The {0} action is not valid for non-travel items when the appointment status is one of the following: {1}, {2}, or {3}.";
            ...
            public const string FSRelatedDocumentNotMatchCurrentDocumentProject                                = "The document cannot be assigned to the expense receipt because the project in the document differs from the project of the expense receipt.";
