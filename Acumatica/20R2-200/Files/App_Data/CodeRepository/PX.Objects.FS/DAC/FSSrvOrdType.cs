...
namespace PX.Objects.FS
{
    ...
    public class FSSrvOrdType : PX.Data.IBqlTable
    {
        ...
        [PXDBString(2, IsFixed = true, IsUnicode = true, InputMask = ">LL")]
        ...
        [PXFormula(typeof(Switch<
                            Case<
                                Where2<
                                    ...
                                    And<
                                        behavior, NotEqual<ListField_Behavior_SrvOrdType.Quote>,
                                        And<behavior, NotEqual<ListField_Behavior_SrvOrdType.InternalAppointment>>>>,
                                True>,
                            False>))]
        ...
        [PXFormula(typeof(Switch<
                            Case<
                                Where<postToSOSIPM, Equal<True>,
                                    Or<behavior, Equal<behavior.Quote>>>,
                                True>,
                            False>))]
