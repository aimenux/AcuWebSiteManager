...
namespace PX.Objects.FS
{
    ...
    public class FSSODet : IBqlTable, IFSSODetBase, IDocLine, ILSPrimary, ISortOrder
    {
        ...
        public static class FK
        {
            ...
            public class SrvOrdType : FSSrvOrdType.PK.ForeignKeyOf<FSSODet>.By<srvOrdType> { }
        }
        #endregion
        ...
        [PXUnboundFormula(typeof(Switch<
                                    Case<
                                        Where<status, Equal<status.ScheduleNeeded>,
        ...
        [PXDBString(2, IsFixed = true)]
        [PXUIField(DisplayName = "Related Doc. Type", Enabled = false, Visible = false)]
