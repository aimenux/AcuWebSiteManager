...
namespace PX.Objects.FS
{
    public class SM_SOOrderEntry : PXGraphExtension<SOOrderEntry>, IInvoiceGraph, IInvoiceContractGraph
    {
        ...
        protected virtual void _(Events.RowSelected<SOOrder> e)
        {
            ...
            PXUIFieldAttribute.SetVisibility<FSxSOLine.newTargetEquipmentLineNbr>(Base.Transactions.Cache, null, inventoryAndEquipmentModuleEnabled ? PXUIVisibility.Visible : PXUIVisibility.Invisible);
        ...
        public virtual void CreateInvoice(PXGraph graphProcess, List<DocLineExt> docLines, short invtMult, DateTime? invoiceDate, string invoiceFinPeriodID, OnDocumentHeaderInsertedDelegate onDocumentHeaderInserted, OnTransactionInsertedDelegate onTransactionInserted, PXQuickProcess.ActionFlow quickProcessFlow)
        {
            ...
            foreach (DocLineExt line in docLines)
            {
                ...
                sOLineRow.CuryExtPrice = Math.Round((decimal)docLine.CuryBillableExtPrice * invtMult, CommonSetupDecPl.PrcCst, MidpointRounding.AwayFromZero);
                sOLineRow.DiscPct = docLine.DiscPct;
                sOLineRow.ManualDisc = docLine.IsFree == true;
        ...
        public virtual FSContractPostDoc CreateInvoiceByContract(PXGraph graphProcess, DateTime? invoiceDate, string invoiceFinPeriodID, FSContractPostBatch fsContractPostBatchRow, FSServiceContract fsServiceContractRow, FSContractPeriod fsContractPeriodRow, List<ContractInvoiceLine> docLines)
        {
            ...
            foreach (ContractInvoiceLine docLine in docLines)
            {
                ...
                Base.Transactions.Cache.SetValueExtIfDifferent<SOLine.manualDisc>(sOLineRow, docLine.IsFree == true);
