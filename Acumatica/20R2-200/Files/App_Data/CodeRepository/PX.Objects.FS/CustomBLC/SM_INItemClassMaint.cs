...
namespace PX.Objects.FS
{
    public class SM_INItemClassMaint : PXGraphExtension<INItemClassMaint>
    {
        ...
        protected virtual void _(Events.FieldDefaulting<INItemClass, FSxServiceClass.dfltBillingRule> e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void _(Events.FieldUpdated<INItemClass, INItemClass.itemType> e)
        {
            ...
            e.Cache.SetDefaultExt<FSxServiceClass.dfltBillingRule>(e.Row);
