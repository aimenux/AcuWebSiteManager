...
namespace PX.Objects.FS
{
        ...
        where TCustomerID : PX.Data.IBqlField
    {
        ...
        protected virtual void _(Events.FieldUpdated<FSScheduleDet, FSScheduleDet.serviceTemplateID> e)
        {
            ...
            FSScheduleDet fsScheduleDetRow = (FSScheduleDet)e.Row;
            FSServiceTemplate fsServiceTemplateRow = PXSelect<FSServiceTemplate,
                                                        Where<FSServiceTemplate.serviceTemplateID, Equal<Required<FSServiceTemplate.serviceTemplateID>>>>
                                                    .Select(this, fsScheduleDetRow.ServiceTemplateID);
