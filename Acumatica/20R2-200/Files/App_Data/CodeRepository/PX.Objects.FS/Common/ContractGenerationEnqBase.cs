...
namespace PX.Objects.FS
{
        ...
        where TRecordType : IConstant<string>, IBqlOperand, new()
    {
                                         ...
                                         bool isPrepaidContract)
        {
            ...
            graphAppointmentEntry.AppointmentRecords.Cache.SetValueExtIfDifferent<FSAppointment.handleManuallyScheduleTime>(fsAppointmentRow, fsScheduleRow.OverrideDuration);
            ...
            if (fsScheduleRow.OverrideDuration == true)
            {
                ...
                graphAppointmentEntry.AppointmentRecords.Cache.SetValueExtIfDifferent<FSAppointment.scheduledDateTimeEnd>(fsAppointmentRow, endDate);
            }
