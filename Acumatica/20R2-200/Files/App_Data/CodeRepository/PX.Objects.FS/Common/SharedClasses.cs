...
namespace PX.Objects.FS
{
    ...
    public class SharedClasses
    {
        ...
        // TODO:
        [Obsolete("This class will be deleted in the next major release. Use ServiceOrderUpdateException instead.")]
        public class FSLotSerialException : PXOuterException
        {
            public FSLotSerialException(SerializationInfo info, StreamingContext context)
                : base(info, context)
            {
            }

            public FSLotSerialException(Dictionary<string, string> innerExceptions, Type graphType, object row, string message)
                : base(innerExceptions, graphType, row, message)
            {
            }

            public FSLotSerialException(Dictionary<string, string> innerExceptions, Type graphType, object row, string format, params object[] args)
                : base(innerExceptions, graphType, row, format, args)
            {
            }
        }
