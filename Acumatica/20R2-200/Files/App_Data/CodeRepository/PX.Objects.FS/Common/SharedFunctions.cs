    ...
    public static class SharedFunctions
    {
        ...
        public static void SetInventoryItemExtensionInfo(PXGraph graph, int? inventoryID, object row)
        {
            ...
            else if (row is FSAppointmentDet)
            {
                ...
                if (fsAppointmentDetRow.LineType == ID.LineType_ALL.INVENTORY_ITEM)
                {
                    fsAppointmentDetRow.BillingRule = ID.BillingRule.FLAT_RATE;
                }
                else
                {
        ...
        public static void DisableAllDACFields(PXCache cache, object row, List<Type> fieldsToIgnore)
        {
