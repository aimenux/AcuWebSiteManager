...
namespace PX.Objects.FS
{
    ...
    public abstract class ListField_Status_Appointment : PX.Data.IBqlField
    {
        public class ListAttribute : PXStringListAttribute
        {
            public ListAttribute()
                : base(new[]
                {
                    Pair(AUTOMATIC_SCHEDULED, TX.Status_Appointment.AUTOMATIC_SCHEDULED),
                    Pair(MANUAL_SCHEDULED, TX.Status_Appointment.MANUAL_SCHEDULED),
                    Pair(IN_PROCESS, TX.Status_Appointment.IN_PROCESS),
                    ...
                    Pair(ON_HOLD, TX.Status_Appointment.ON_HOLD),
        ...
        public const string AUTOMATIC_SCHEDULED = ID.Status_Appointment.AUTOMATIC_SCHEDULED;
        public const string MANUAL_SCHEDULED = ID.Status_Appointment.MANUAL_SCHEDULED;
        public const string ON_HOLD = ID.Status_Appointment.ON_HOLD;
        public const string IN_PROCESS = ID.Status_Appointment.IN_PROCESS;
        public const string PAUSED = ID.Status_Appointment.PAUSED;
        public const string COMPLETED = ID.Status_Appointment.COMPLETED;
        public const string CLOSED = ID.Status_Appointment.CLOSED;
        public const string CANCELED = ID.Status_Appointment.CANCELED;

        public class AutomaticScheduled : PX.Data.BQL.BqlString.Constant<AutomaticScheduled>
		{
            public AutomaticScheduled() : base(AUTOMATIC_SCHEDULED)
            {
            }
        }
		...
		{
            public ManualScheduled() : base(MANUAL_SCHEDULED)
            {
            }
        }
    ...
    public abstract class ListField_Linked_Entity_Type : PX.Data.IBqlField
    {
        public class ListAttribute : PXStringListAttribute
        {
            public ListAttribute()
    ...
    public abstract class ListField_FSEntity_Type : PX.Data.IBqlField
    {
        public class ListAttribute : PXStringListAttribute
        {
            public ListAttribute()
