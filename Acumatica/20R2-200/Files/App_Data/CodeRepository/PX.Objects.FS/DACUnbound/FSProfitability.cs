...
namespace PX.Objects.FS
{
    ...
    public class FSProfitability : IBqlTable
    {
        ...
        public FSProfitability(FSAppointmentDet fsAppointmentDetRow)
        {
            ...
            this.EstimatedCost = this.EstimatedQty * this.UnitCost;
            this.ExtCost = (fsAppointmentDetRow.IsExpenseReceiptItem == true ? fsAppointmentDetRow.CuryExtCost : this.ActualQty * this.UnitCost);
            this.Profit = Math.Round((decimal)this.BillableAmount, 2) - Math.Round((decimal)this.ExtCost, 2);
            this.ProfitPercent = this.ExtCost == 0.0m ? 0.0m : (this.Profit / this.ExtCost) * 100;
        }
        ...
        public FSProfitability(FSLog fsLogRow)
        {
            ...
            this.ExtCost = fsLogRow.CuryExtCost;
            this.BillableQty = 0m;
