...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.KitAssemblyEntry" PrimaryView="Document" UDFTypeField="DocType" EnableAttributes="true" >
        <CallbackCommands>
