        ...
        <Items>
			...
			<px:PXTabItem Text="Manufacturing">
				<Template>
					...
					<px:PXLayoutRule runat="server" Merge="True" />
					<px:PXDropDown runat="server" CommitChanges="True" DataField="AMReplenishmentSource" ID="edAMReplenishmentSource" Size="SM" />
					<px:PXCheckBox runat="server" CommitChanges="True" DataField="AMReplenishmentPolicyOverride" ID="chkAMReplenishmentPolicyOverride" />
					<px:PXSelector runat="server" DataField="AMReplenishmentSourceSiteID" ID="edAMReplenishmentSourceSiteID" />
					<px:PXLayoutRule runat="server" />
					<px:PXLayoutRule runat="server" Merge="True" />
