		...
		<Items>
			<px:PXTabItem Text="Connection Settings">
				<Template>
					...
					<px:PXTextEdit CommitChanges="True" Size="" runat="server" ID="CstPXTextEdit60" DataField="CurrentBindingBigCommerce.StoreAdminUrl"></px:PXTextEdit>
					<px:PXLayoutRule runat="server" ControlSize="XL" LabelsWidth="SM" StartGroup="True" GroupCaption="REST Settings"></px:PXLayoutRule>
					<px:PXTextEdit ID="edStoreBaseURL" runat="server" AlreadyLocalized="False" DataField="CurrentBindingBigCommerce.StoreBaseURL" CommitChanges="True"></px:PXTextEdit>
					<px:PXTextEdit ID="edStoreXAuthClient" runat="server" AlreadyLocalized="False" DataField="CurrentBindingBigCommerce.StoreXAuthClient" CommitChanges="True"></px:PXTextEdit>
					<px:PXTextEdit ID="edStoreXAuthToken" runat="server" AlreadyLocalized="False" DataField="CurrentBindingBigCommerce.StoreXAuthToken" CommitChanges="True"></px:PXTextEdit>
					<px:PXLayoutRule ControlSize="XL" LabelsWidth="SM" runat="server" GroupCaption="WebDAV Settings" StartGroup="True"></px:PXLayoutRule>
					<px:PXTextEdit CommitChanges="True" runat="server" ID="CstPXTextEdit8" DataField="CurrentBindingBigCommerce.StoreWDAVServerUrl"></px:PXTextEdit>
					<px:PXTextEdit ID="edStoreWDAVClientUser" runat="server" AlreadyLocalized="False" DataField="CurrentBindingBigCommerce.StoreWDAVClientUser" CommitChanges="True"></px:PXTextEdit>
					<px:PXTextEdit ID="edStoreWDAVClientPass" runat="server" AlreadyLocalized="False" DataField="CurrentBindingBigCommerce.StoreWDAVClientPass" CommitChanges="True"></px:PXTextEdit>
					<px:PXLayoutRule runat="server" ID="PXLayoutRule1" StartColumn="True" LabelsWidth="" StartGroup=""></px:PXLayoutRule>
					<px:PXLayoutRule runat="server" ID="CstPXLayoutRule121" StartGroup="True" GroupCaption="System Settings" ControlSize="XL" LabelsWidth="SM"></px:PXLayoutRule>
					<px:PXSelector runat="server" ID="CstPXSelector120" DataField="CurrentBinding.LocaleName"></px:PXSelector>
					<px:PXLayoutRule runat="server" ControlSize="XL" LabelsWidth="SM" StartGroup="True" GroupCaption="Store Properties"></px:PXLayoutRule>
					<px:PXTextEdit runat="server" ID="edBigCommerceDefaultCurrency" DataField="CurrentBindingBigCommerce.BigCommerceDefaultCurrency"></px:PXTextEdit>
					<px:PXTextEdit runat="server" ID="edBigCommerceStoreTimeZone" DataField="CurrentBindingBigCommerce.BigCommerceStoreTimeZone"></px:PXTextEdit>
				</Template>
			...
			<px:PXTabItem Text="Payment Settings">
				<Template>
					...
					<px:PXGrid SyncPosition="True" TabIndex="30400" Height="160px" runat="server" ID="PaymentsMethods" AllowPaging="False" AutoAdjustColumns="False" Caption="Base Currency Payment Methods" CaptionVisible="True" MatrixMode="True" SkinID="Inquire" Width="800px">
						<Levels>
					...
					<px:PXGrid SkinID="Details" Width="800px" runat="server" ID="gridMultiCurrency" AllowPaging="False" AutoAdjustColumns="False" Caption="Multicurrency Cash Account" CaptionVisible="True" Height="100px">
						<Levels>
