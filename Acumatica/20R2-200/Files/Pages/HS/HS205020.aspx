<%@ Page Language="C#" MasterPageFile="~/MasterPages/ListView.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="HS205020.aspx.cs"
	Inherits="Page_HS205020" Title="Real-Time Sync" %>

<%@ MasterType VirtualPath="~/MasterPages/ListView.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" Width="100%" runat="server" TypeName="PX.DataSync.HubSpot.HSSetupMaint" PrimaryView="EntitySetup" Visible="True">
		<CallbackCommands>
		...
		<Levels>
			<px:PXGridLevel DataMember="EntitySetup">
				<Columns>
					...
					<px:PXGridColumn DataField="PoolingPeriod" Width="110px" />
