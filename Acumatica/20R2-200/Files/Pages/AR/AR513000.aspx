		...
		<Levels>
			<px:PXGridLevel DataMember="PaymentTrans">
                <Columns>
					...
					<px:PXGridColumn DataField="ProcStatus" Width="200px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="LastActivityDate" Width="130px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="TranNumber" Width="160px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="ProcessingCenterID" LinkCommand="ViewProcessingCenter" Width="130px">
                    </px:PXGridColumn>
					<px:PXGridColumn DataField="SaveProfile" Width="130px" Type="CheckBox"> </px:PXGridColumn>
					<px:PXGridColumn DataField="NeedSync" Width="130px" Type="CheckBox"></px:PXGridColumn>
                </Columns>
			</px:PXGridLevel>
		</Levels>
