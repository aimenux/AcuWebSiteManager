...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource EnableAttributes="true" ID="ds" UDFTypeField="DocType" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AR.ARInvoiceEntry" PrimaryView="Document">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="ReleaseFromCreditHold" Visible="false" CommitChanges="true" />
		...
		<Items>
			...
			<px:PXTabItem Text="Financial Details">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Dunning Info" ControlSize="M" LabelsWidth="SM" StartGroup="true" StartColumn="true"/>
