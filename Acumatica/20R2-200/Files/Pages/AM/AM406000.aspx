<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="AM406000.aspx.cs" Inherits="Page_AM406000" Title="Work Center Capacity" %>
<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AM.MachineCapacityInq" PrimaryView="CapacityFilter">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="CapacityFilter" DefaultControlID="edMachID" TabIndex="100" >
        <Template>
            <px:PXLayoutRule runat="server" StartColumn="True"/>
            <px:PXSelector ID="edMachID" runat="server" DataField="MachID" CommitChanges="True" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" TabIndex="1700">
		<Levels>
			<px:PXGridLevel DataKeyNames="MachID,SchdDate" DataMember="CapacityDetail">
                <RowTemplate>
                ...
                <Columns>
                    <px:PXGridColumn DataField="MachID"/>
