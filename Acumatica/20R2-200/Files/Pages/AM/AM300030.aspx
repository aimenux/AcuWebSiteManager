...
<asp:content id="cont1" contentplaceholderid="phDS" runat="Server">
    ...
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AM.ScanMaterialHost" PrimaryView="HeaderView">
        <CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="LSAMMaterial_generateLotSerial" Visible="false" />
			<px:PXDSCallbackCommand Name="LSAMMaterial_binLotSerial" Visible="false" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:content>
