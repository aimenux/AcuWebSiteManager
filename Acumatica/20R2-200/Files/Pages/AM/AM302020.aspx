...
<asp:content id="cont1" contentplaceholderid="phDS" runat="Server">
    ...
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AM.ScanLaborHost" PrimaryView="HeaderView">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="ScanRemove" Visible="false" CommitChanges="True" />
			...
			<px:PXDSCallbackCommand Name="LSAMMove_generateLotSerial" Visible="false" />
			<px:PXDSCallbackCommand Name="LSAMMove_binLotSerial" Visible="false" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:content>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="transactions">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ShiftID" Width="90px" />
