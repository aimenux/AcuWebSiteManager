		...
		<px:PXGrid ID="gridTables" runat="server" DataSourceID="ds" Height="243px" Width="100%" Style="z-index: 100" SyncPosition="true"
			...
			<Levels>
				<px:PXGridLevel DataMember="TablesInformation">
					<Columns>
						...
						<px:PXGridColumn DataField="LinkedFrom" Label="Linked From" />
					</Columns>
			...
			<ActionBar>
				<CustomItems>
					...
					<px:PXToolBarButton CommandName="selectChildTable" CommandSourceID="ds" Text="Select Child Table"
						Tooltip="Defines child table to parent selector.">
					</px:PXToolBarButton>
				</CustomItems>
			</ActionBar>
		</px:PXGrid>
							...
							<px:PXGrid ID="grdOns" runat="server" DataSourceID="ds" Height="200px" Width="100%" AutoAdjustColumns="True"
								...
								<ActionBar>
									<CustomItems>
										...
										<px:PXToolBarButton CommandSourceID="ds" CommandName="browseForRelation" Text="Browse For Relations"
											Tooltip="Open Related Table Lookup for selected Table.">
										</px:PXToolBarButton>
									</CustomItems>
								</ActionBar>
