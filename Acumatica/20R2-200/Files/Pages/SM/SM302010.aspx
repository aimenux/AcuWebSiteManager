...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" TypeName="PX.BusinessProcess.UI.QueueDispatchersMonitor" SuspendUnloading="False" PrimaryView="Status">
        <CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="purgeCommerceQueue"  Visible="False" RepaintControls="All"/>
			<px:PXDSCallbackCommand Name="clearCqdLog"  Visible="False" RepaintControls="All"/>
			<px:PXDSCallbackCommand Name="restartCqd"  Visible="False" RepaintControls="All"/>
        </CallbackCommands>
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" 
		...
		<Template>
			<px:PXPanel runat="server" ID="PXPanel1" Caption="Push Notification Queue">
                <px:PXLayoutRule runat="server" StartRow="True" ControlSize="XL" LabelsWidth="SM" ColumnSpan="2"/>
            ...
            <px:PXPanel runat="server" ID="PXPanel4" Caption="Commerce Queue">
                <px:PXLayoutRule runat="server" StartRow="True" ControlSize="XL" LabelsWidth="SM" ColumnSpan="2"/>
                <px:PXTextEdit ID="edCqdQueueName" runat="server" DataField="CqdQueueName" AlreadyLocalized="False"/>
                <px:PXLayoutRule runat="server" ControlSize="M" LabelsWidth="SM" ColumnSpan="2"/>
                <px:PXDropDown ID="edCqdStatus" runat="server" DataField="CqdStatus" Enabled="False"/>
                <px:PXLayoutRule runat="server" />
                <px:PXDropDown ID="edCqdPerformanceStatus" runat="server" DataField="CqdPerformanceStatus" Enabled="False"/>
                <px:PXLayoutRule runat="server" ColumnSpan="2" />
                <px:PXTextEdit ID="edCommerceQueueCount" runat="server" DataField="CommerceQueueCount"/>
                <px:PXTextEdit ID="edCommerceQueueSize" runat="server" DataField="CommerceQueueSize"/>
                <px:PXLayoutRule runat="server" StartColumn="True" ControlSize="M" LabelsWidth="SM" />
                <px:PXButton runat="server" ID="PXButton2" Text="VIEW DETAILS" AlignLeft="false" AlreadyLocalized="False" AutoRefresh="True" AutoAdjustColumns="True" 
                             CommandName="viewCqdLog" CommandSourceID="ds" PopupPanel="PanelCqdLogDetails" >
                </px:PXButton>
                <px:PXLayoutRule runat="server" StartRow="True" Merge="True" />
                <px:PXButton runat="server" ID="bPurgeCommerceQueue" AlignLeft="False" AlreadyLocalized="False" AutoRefresh="True" 
                             CommandName="purgeCommerceQueue" CommandSourceID="ds"></px:PXButton>
                <px:PXButton runat="server" ID="bRestartCommerceDispatcher" AlignLeft="False" AlreadyLocalized="False" AutoRefresh="True" 
                             CommandName="restartCqd" CommandSourceID="ds"></px:PXButton>
            </px:PXPanel>
		</Template>
	</px:PXFormView>
	...
	<px:PXSmartPanel ID="PanelCqdLogDetails" runat="server" style="height:460px;width:800px;" CaptionVisible="True" Caption="Commerce Processing Log" Key="CommerceQueueDispatcherLogDetail"
                     AutoReload="True" AutoRepaint="True">
        <px:PXFormView ID="CqdLogDetailView" runat="server" DataSourceID="ds" Style="z-index: 500" 
                       Width="100%" Height="400px" DataMember="CommerceQueueDispatcherLogDetail" TabIndex="5500">
            <Template>
                <px:PXLayoutRule runat="server" ControlSize="M" LabelsWidth="SM" Merge="True" GroupCaption="Statistics"/>
                <px:PXTextEdit ID="edCProcessTime" runat="server" DataField="ProcessingTime" AlreadyLocalized="False"/>
                <px:PXTextEdit ID="edCDate" runat="server" TextMode="DateTimeLocal" DataField="Date" Enabled="False" />
                <px:PXLayoutRule runat="server" StartRow="True" GroupCaption="Detailed Log" />
                <px:PXTextEdit ID="edCLog" runat="server" DataField="Log" Enabled="False" TextMode="MultiLine" Height="290" SuppressLabel="True" ></px:PXTextEdit>
            </Template>
        </px:PXFormView>
        <px:PXPanel ID="PXPanel6" SkinID="Buttons" runat="server">
            <px:PXButton ID="BtnClearCqd" runat="server" Text="Clear Log" CommandName="clearCqdLog" CommandSourceID="ds"/>
            <px:PXButton ID="PanelCqdLogDetailsSubmit" runat="server" DialogResult="OK" Text="Close" />
        </px:PXPanel>
    </px:PXSmartPanel>
