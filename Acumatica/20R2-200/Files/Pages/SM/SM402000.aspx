...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.SM.MergedDatabaseSchemaInquiry" PageLoadBehavior="GoFirstRecord" PrimaryView="inspectingTables">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="inspectingTables" TabIndex="1600">
		<Template>
			...
			<px:PXTextEdit runat="server" DataField="Description" ID="edDescription" ValidateRequestMode="Inherit" TextMode="MultiLine" Height="100%" Width="100%"></px:PXTextEdit>
						...
						<Levels>
							<px:PXGridLevel DataMember="tableIncomingReferences">
								<RowTemplate>
									...
									<px:PXTextEdit runat="server" DataField="ChildDescription" ID="edDescription" ValidateRequestMode="Inherit"></px:PXTextEdit>
								...
								<Columns>
									...
									<px:PXGridColumn DataField="ChildDescription" Width="500px" AllowShowHide="True"></px:PXGridColumn>
