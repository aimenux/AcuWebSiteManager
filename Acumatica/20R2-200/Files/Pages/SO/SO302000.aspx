...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource  EnableAttributes="true" UDFTypeField="ShipmentType" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.SO.SOShipmentEntry" PrimaryView="Document">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="RecalculatePackages" Visible="False" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="LSSOShipLine_generateLotSerial" Visible="False" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="LSSOShipLine_binLotSerial" Visible="False" CommitChanges="True" DependOnGrid="grid" />
			...
			<px:PXDSCallbackCommand Name="AddressLookup" CommitChanges="true" Visible="false" SelectControlsIDs="form" RepaintControls="None" RepaintControlsIDs="ds,formB" />
		</CallbackCommands>
		<DataTrees>
