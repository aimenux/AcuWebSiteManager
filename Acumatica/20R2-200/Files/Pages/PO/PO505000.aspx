        ...
        <Levels>
            <px:PXGridLevel DataMember="FixedDemand">
                ...
                <Columns>
					...
					<px:PXGridColumn DataField="AMProdMatlSplit__OrderType" Width="70" />
					<px:PXGridColumn DataField="AMProdMatlSplit__ProdOrdID" Width="70" LinkCommand="ViewProdDocument" />
