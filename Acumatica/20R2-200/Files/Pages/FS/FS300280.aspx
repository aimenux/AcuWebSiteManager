<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormTab.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="FS300280.aspx.cs" Inherits="Page_FS300280" Title="Untitled Page" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" PrimaryView="Filter" TypeName="PX.Objects.FS.AppResumeServiceEntry" SuspendUnloading="False">
        <CallbackCommands>
