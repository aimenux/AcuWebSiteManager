<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormTab.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="FS300270.aspx.cs" Inherits="Page_FS300270" Title="Untitled Page" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" PrimaryView="Filter" TypeName="PX.Objects.FS.AppPauseServiceEntry" SuspendUnloading="False">
        <CallbackCommands>
