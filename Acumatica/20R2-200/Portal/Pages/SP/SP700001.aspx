...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Width="100%" TypeName="SP.Objects.IN.InventoryCardMaint" 
        ...
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand DependOnGrid="gridDocumentDetails" Name="Configure" Visible="False"/>
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
    ...
    <px:PXGrid ID="gridDocumentDetails" runat="server" DataSourceID="ds"
        ...
        <Levels>
            <px:PXGridLevel DataMember="DocumentDetails">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="AMIsConfigurable" Type="CheckBox" TextAlign="Center" Width="110px" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
        ...
        <ActionBar>
            ...
            <CustomItems>
                ...
                <px:PXToolBarButton Text="Configure" DependOnGrid="grid" StateColumn="AMIsConfigurable" ImageKey="Settings">
                    <AutoCallBack Command="Configure" Target="ds" />
                </px:PXToolBarButton>
            </CustomItems>
        </ActionBar>
    </px:PXGrid>
