...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXFormView ID="form1" runat="server" Width="100%" Caption="Account Summary" DataSourceID="ds" DataMember="CurrentBAccount">
        <Template>
            ...
            <px:PXFormView ID="frmDefContact" runat="server" CaptionVisible="False" DataMember="DefContact" DataSourceID="ds" SkinID="Transparent">
                <Template>
                    ...
                    <px:PXTextEdit ID="edEMail" runat="server" DataField="EMail" CommandName="NewMailActivity" CommandSourceID="ds" CommitChanges="True"/>
            ...
            <px:PXFormView ID="frmDefAddress" runat="server" CaptionVisible="False" DataSourceID="ds" DataMember="DefAddress" SkinID="Transparent">
                <Template>
                    ...
                    <px:PXSelector ID="edCountryID" runat="server" DataField="CountryID" FilterByAllFields="True" TextMode="Search" DisplayMode="Hint" CommitChanges="True" />
                    <px:PXSelector ID="edState" runat="server" AutoRefresh="True" DataField="State" CommitChanges="true" FilterByAllFields="True" TextMode="Search" DisplayMode="Hint" />
                    ...
                    <px:PXButton ID="btnViewOnMap" runat="server" CommandName="ViewMainOnMap" CommandSourceID="ds" Size="xs" Text="View On Map" Height="20" />
