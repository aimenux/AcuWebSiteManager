...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.SO.SOOrderEntry" PrimaryView="Document">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Visible="false" Name="CreateShipmentIssue" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="CreateShipmentReceipt" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="ReleaseFromCreditHold" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="ReleaseFromHold" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="PutOnHold" CommitChanges="true" />
            ...
            <px:PXDSCallbackCommand Visible="false" Name="CreateDocumentPayment" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="CreateOrderPrepayment" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="MobileCreatePayment" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="MobileCreatePrepayment" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="CaptureDocumentPayment" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="VoidDocumentPayment" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="ImportDocumentPayment" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="ImportDocumentPaymentCreate" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="CreatePaymentOK" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="CreatePaymentCapture" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="CreatePaymentAuthorize" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="SyncPaymentTransaction" CommitChanges="true" />
            ...
            <px:PXDSCallbackCommand Name="AddressLookup" RepaintControls="None" CommitChanges="true" Visible="false" />
            <px:PXDSCallbackCommand Name="ShippingAddressLookup" SelectControlsIDs="toolbar1" RepaintControls="None" RepaintControlsIDs="ds,PXWizard" CommitChanges="true" Visible="false" />
        </CallbackCommands>
        <DataTrees>
